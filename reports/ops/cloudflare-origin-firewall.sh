...
# Generated by scripts/dns/cloudflare-ips.ts
# Allows Cloudflare proxy ranges to reach HTTP/HTTPS and drops other public traffic.
# Review before applying in production, especially if you have trusted partner source ranges.
...
# Optional hardening: drop all other HTTP/HTTPS sources after allow rules are in place.
