...
- Name: e2e\member-journey.spec.ts >> Member journey >> GAP-01 — Governance persona: no edit/write controls visible >> governance: no submit/create buttons visible on landing page
- Location: e2e\member-journey.spec.ts:185:9
...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    ...
    - waiting for" http://localhost:3002/en-CA/dashboard/inbox" navigation to finish...
    - navigated to "http://localhost:3002/en-CA/dashboard/inbox"
    3 × unexpected value "http://localhost:3002/en-CA/dashboard/inbox"
