...
- Name: e2e\governance\deployment-legitimacy-visibility.spec.ts >> governance: deployment legitimacy visibility >> attestation surface accepts release id queries without 5xx
- Location: e2e\governance\deployment-legitimacy-visibility.spec.ts:14:7
...
Call log:
  - → GET http://localhost:3002/api/health?releaseId=UE-DEV
    - user-agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.7727.15 Safari/537.36
    - accept: */*
    - accept-encoding: gzip,deflate,br
    - cookie: nzila_session=CS2jOCTWrm3AWWGITxDKYjZcChc3Pz4tYa1y7dsWjxo
