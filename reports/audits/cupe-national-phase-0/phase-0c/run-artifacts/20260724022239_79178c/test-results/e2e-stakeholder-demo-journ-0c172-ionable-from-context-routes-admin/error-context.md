...
- Name: e2e\stakeholder-demo-journeys.spec.ts >> Marketing-to-app continuity routes >> pilot request CTA remains actionable from context routes
- Location: e2e\stakeholder-demo-journeys.spec.ts:183:7
...
Call log:
  - navigating to "http://localhost:3002/en-CA/proof?context=procurement", waiting until "domcontentloaded"
