...
- Name: e2e\ocra-adaptive-flow.spec.ts >> OCRA adaptive live flow — telemetry privacy (network) >> telemetry POSTs never carry org names or free text
- Location: e2e\ocra-adaptive-flow.spec.ts:56:7
...
Call log:
  - navigating to "http://localhost:3002/en-CA/continuity-assessment/start", waiting until "load"
