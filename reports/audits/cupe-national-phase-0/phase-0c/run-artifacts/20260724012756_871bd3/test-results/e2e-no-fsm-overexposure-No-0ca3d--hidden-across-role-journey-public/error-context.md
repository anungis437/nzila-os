...
- Name: e2e\no-fsm-overexposure.spec.ts >> No FSM overexposure in pilot-facing UX >> governance: raw FSM terms are hidden across role journey
...
Call log:
  - navigating to "http://localhost:3002/en-CA/dashboard/continuity-intelligence", waiting until "domcontentloaded"
