...
- Name: e2e\permission-boundaries.spec.ts >> Permission boundaries — role gate enforcement >> Member role — blocked admin surfaces >> member: /dashboard/billing-admin is blocked
- Location: e2e\permission-boundaries.spec.ts:107:9
