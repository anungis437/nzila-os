...
- Name: e2e\permission-boundaries.spec.ts >> Permission boundaries — role gate enforcement >> Member role — blocked admin surfaces >> member: /dashboard/documents is blocked (P1 — missing server-side gate)
- Location: e2e\permission-boundaries.spec.ts:97:9
...
Call log:
  - navigating to "http://localhost:3002/en-CA/dashboard", waiting until "domcontentloaded"
