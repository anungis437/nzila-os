...
- Name: e2e\authenticated-role-navigation.spec.ts >> UnionEyes authenticated role-centric navigation >> executive: /dashboard redirects to centralized landing and role IA
