...
> **Option D — Governed hybrid architecture**, selected by Aubert on
> 2026-07-23. Phase 0B.2 implements the foundational slice only on the
> clean branch `fix/union-eyes-phase0b-clean`. See
> [phase-0b2/phase-0b2-architecture-approval.md](phase-0b2/phase-0b2-architecture-approval.md).
> Phase 0B remains AMBER until Phase 0B.2 closes GREEN under its own
> Section 20 criteria.
