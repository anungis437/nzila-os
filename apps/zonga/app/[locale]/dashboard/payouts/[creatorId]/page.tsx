...
export default async function CreatorPayoutDetailPage({
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        <div className="p-5">
          <h2 className="mb-3 text-sm font-semibold text-navy">Revenue Breakdown</h2>
        ...
        <div className="p-5">
          ...
          <dl className="grid grid-cols-2 gap-4 text-sm md:grid-cols-3">
            <div>
              ...
              <dd className="text-lg font-bold text-navy">{payoutResult.total}</dd>
            </div>
            <div>
              <dt className="text-gray-500">Catalog Size</dt>
              <dd className="text-lg font-bold text-navy">{detail.assets} tracks</dd>
            </div>
            <div>
