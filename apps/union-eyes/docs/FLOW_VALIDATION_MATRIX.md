...
| `withOrganizationAuth()` — org isolation | `lib/organization-middleware.ts` | NextAuth session + org RLS | All authenticated roles | ✅ VALIDATED — used in grievances, cases, search routes |
