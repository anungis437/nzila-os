...
VALUES
  ('d1a00001-0001-4000-8000-000000000001', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'usr-l123-005', 'steward', 'active', 'Jean-Pierre Tremblay', 'jp.tremblay@cupe123.ca', 'Building Services', 'Senior Inspector', 'CL123-005', '2014-03-15', 12, now(), now()),
  ('d1a00001-0001-4000-8000-000000000002', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'usr-l123-006', 'member', 'active', 'Fatima Al-Rashid', 'f.alrashid@cupe123.ca', 'Community Services', 'Program Coordinator', 'CL123-006', '2019-07-01', 7, now(), now()),
  ('d1a00001-0001-4000-8000-000000000003', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'usr-l123-007', 'member', 'active', 'David Okafor', 'david.okafor@cupe123.ca', 'Roads and Drainage', 'Equipment Operator', 'CL123-007', '2020-01-10', 6, now(), now()),
  ('d1a00001-0001-4000-8000-000000000004', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'usr-l123-008', 'member', 'active', 'Sophie Martin', 'sophie.martin@cupe123.ca', 'City Clerk''s Office', 'Administrative Assistant', 'CL123-008', '2017-09-20', 9, now(), now()),
  ('d1a00001-0001-4000-8000-000000000005', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'usr-l123-009', 'member', 'active', 'Carlos Vega', 'carlos.vega@cupe123.ca', 'Parks and Facilities', 'Parks Maintenance Worker', 'CL123-009', '2021-05-01', 5, now(), now()),
  ('d1a00001-0001-4000-8000-000000000006', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'usr-l123-010', 'steward', 'active', 'Priya Sharma', 'priya.sharma@cupe123.ca', 'Building Operations', 'Building Maintenance Technician', 'CL123-010', '2018-11-15', 8, now(), now()),
  ('d1a00001-0001-4000-8000-000000000007', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'usr-l123-011', 'member', 'active', 'Liam Chen', 'liam.chen@cupe123.ca', 'Information Technology', 'IT Support Analyst', 'CL123-011', '2022-03-01', 4, now(), now()),
  ('d1a00001-0001-4000-8000-000000000008', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'usr-l123-012', 'member', 'active', 'Isabelle Nguyen', 'isabelle.nguyen@cupe123.ca', 'Ottawa Public Library', 'Library Technician', 'CL123-012', '2023-01-15', 3, now(), now())
...
VALUES
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', '12a1844e-014d-48c6-9e9a-543942d42517',
  ...
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', '12a1844e-014d-48c6-9e9a-543942d42517',
   '14.01', 'health_safety', 'Occupational Health and Safety',
...
INSERT INTO cba_clauses (id, organization_id, cba_id, clause_number, clause_type, title, content, article_number, order_index, created_at, updated_at)
VALUES
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'c89170f0-256f-44f3-a579-894360c2675c',
   '1.01', 'other', 'Purpose and Scope',
  ...
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'c89170f0-256f-44f3-a579-894360c2675c',
   '8.01', 'health_safety', 'Safety Equipment and PPE',
...
-- 3. Negotiations
-- ─────────────────────────────────────────────────────────────────────────────
-- Add missing CAPE TC Group CBA (referenced by negotiation below)
INSERT INTO collective_agreements (id, organization_id, cba_number, title, jurisdiction, employer_name, union_name, industry_sector, effective_date, expiry_date, status, created_at, updated_at)
VALUES
  ('c3d4e5f6-a7b8-4c9d-0e1f-2a3b4c5d6e7f', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6',
   'TC-CAPE-2021-001', 'CAPE TC Group Collective Agreement 2021-2025', 'federal',
   'Treasury Board of Canada Secretariat', 'Canadian Association of Professional Employees (CAPE)',
   'Federal Public Service',
   '2021-01-01', '2025-06-30', 'expired', now(), now())
ON CONFLICT (id) DO NOTHING;

-- Add missing L123 expired CBA (referenced by completed negotiation below)
INSERT INTO collective_agreements (id, organization_id, cba_number, title, jurisdiction, employer_name, union_name, industry_sector, effective_date, expiry_date, status, created_at, updated_at)
VALUES
  ('ca9c6388-a7ec-40b7-91b1-44380641e394', '9210418f-6a4f-4dab-a7d2-4450d581dc81',
   'CUPE123-IW-2020', 'CUPE Local 123 Inside Workers CBA 2020-2023', 'ontario',
   'City of Toronto', 'Canadian Union of Public Employees',
   'public_administration',
   '2020-01-01', '2023-12-31', 'expired', now(), now())
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ('bb000001-0001-4000-8000-000000000001', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6',
...
VALUES
  ('bb000001-0001-4000-8000-000000000002', '9210418f-6a4f-4dab-a7d2-4450d581dc81',
...
VALUES
  ('bb000001-0001-4000-8000-000000000003', '9210418f-6a4f-4dab-a7d2-4450d581dc81',
...
VALUES
  ('cc000001-0001-4000-8000-000000000001', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', '3ea05964-824e-4e5a-a22f-4111c6f0f774', 'National Capital Region', 'Grievances – Classification', true, 15, 6, now(), now()),
  ('cc000001-0001-4000-8000-000000000002', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'cf3c73a8-3424-4c41-8a4e-bf5e6dcfd3a9', 'National Capital Region', 'Harassment and Discipline', true, 12, 4, now(), now()),
  ('cc000001-0001-4000-8000-000000000003', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'b45b99ed-fe83-4166-8b98-e4a3246e0131', 'Western Canada', 'Health & Safety', true, 10, 3, now(), now()),
  ('cc000001-0001-4000-8000-000000000004', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'df93b6d0-f9b4-4689-a75b-360a8a95c882', 'Quebec', 'Pay and Benefits', true, 12, 5, now(), now())
ON CONFLICT (id) DO NOTHING;

-- L123 stewards (use member id as user_id since stewards.user_id is UUID)
INSERT INTO stewards (id, org_id, user_id, region, specialization, active, max_caseload, current_caseload, created_at, updated_at)
VALUES
  ('cc000001-0001-4000-8000-000000000005', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'd1a00001-0001-4000-8000-000000000001', 'Ottawa – Inside', 'Grievances – General', true, 12, 5, now(), now()),
  ('cc000001-0001-4000-8000-000000000006', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'd1a00001-0001-4000-8000-000000000006', 'Ottawa – Outside', 'Health & Safety', true, 10, 7, now(), now()),
  ('cc000001-0001-4000-8000-000000000007', '9210418f-6a4f-4dab-a7d2-4450d581dc81', '2f5bdfe0-7d87-47b7-b2c3-36242b256a4f', 'Ottawa – Inside', 'Discipline and Discharge', true, 10, 4, now(), now())
ON CONFLICT (id) DO NOTHING;

-- ─────────────────────────────────────────────────────────────────────────────
-- 5. Steward Assignments (DISABLED — steward_assignments.steward_id FK→profiles.user_id
--    requires real Clerk profiles; steward table rows are seeded above)
-- ─────────────────────────────────────────────────────────────────────────────
...
-- VALUES
--   (gen_random_uuid(), '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'cc000001-0001-4000-8000-000000000001', 'chief_steward', 'active', 'Translation Bureau', '2024-06-01', 85, true, '2024-05-15', '2024-06-01', '2027-06-01', 'email', 'Chief steward – PA Group NCR', now(), now()),
--   (gen_random_uuid(), '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'cc000001-0001-4000-8000-000000000002', 'steward', 'active', 'Policy and Programs', '2025-01-10', 60, true, '2024-12-20', '2025-01-10', '2028-01-10', 'phone', 'Handles harassment cases in Policy branch', now(), now()),
--   (gen_random_uuid(), '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'cc000001-0001-4000-8000-000000000003', 'steward', 'active', 'Regional Operations', '2025-03-01', 45, true, '2025-02-15', '2025-03-01', '2028-03-01', 'email', 'Western Canada regional steward', now(), now()),
--   (gen_random_uuid(), '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'cc000001-0001-4000-8000-000000000004', 'steward', 'active', 'Financial Services', '2024-09-15', 70, true, '2024-09-01', '2024-09-15', '2027-09-15', 'email', 'Specializes in pay equity and classification grievances', now(), now()),
--   (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'cc000001-0001-4000-8000-000000000005', 'chief_steward', 'active', 'Administrative Services', '2024-01-15', 120, true, '2024-01-10', '2024-01-15', '2027-01-15', 'phone', 'Chief steward for Inside Workers unit', now(), now()),
--   (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'cc000001-0001-4000-8000-000000000006', 'steward', 'active', 'Parks and Roads', '2025-04-01', 95, true, '2025-03-20', '2025-04-01', '2028-04-01', 'phone', 'Health & Safety lead for outdoor crews', now(), now()),
--   (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'cc000001-0001-4000-8000-000000000007', 'steward', 'active', 'Public Works', '2024-06-01', 80, true, '2024-05-28', '2024-06-01', '2027-06-01', 'email', 'Handles discipline and discharge cases', now(), now())
-- ON CONFLICT (id) DO NOTHING;
...
VALUES
  (gen_random_uuid(), '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'Steward Fundamentals', 'Introduction to steward duties, rights, and responsibilities under the collective agreement. Covers duty of fair representation, grievance intake procedures, and time limits.', '2 days', true, 'CAPE Steward Certificate', true, now(), now()),
  (gen_random_uuid(), '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'Advanced Grievance Handling', 'In-depth grievance investigation, evidence gathering, preparation for hearings, and settlement negotiation techniques.', '3 days', true, 'Advanced Grievance Certificate', true, now(), now()),
  (gen_random_uuid(), '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'Workplace Harassment Prevention', 'Recognizing, responding to, and preventing workplace harassment and violence. Includes trauma-informed approaches.', '1 day', false, NULL, true, now(), now()),
  (gen_random_uuid(), '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'Collective Bargaining Essentials', 'Preparation for bargaining: proposal development, costing, negotiation strategies, and ratification processes.', '5 days', true, 'Bargaining Team Certificate', true, now(), now()),

  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'CUPE Steward Training – Level 1', 'Basic steward rights and responsibilities, understanding the collective agreement, and grievance filing procedures. Aligns with CUPE National education program.', '2 days', true, 'CUPE Steward Level 1', true, now(), now()),
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'WHMIS and Workplace Safety', 'Workplace Hazardous Materials Information System training plus site-specific safety orientation for inside and outside workers.', '1 day', true, 'WHMIS Certificate', true, now(), now()),
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'Joint Health & Safety Committee', 'Training for JHSC members: inspections, accident investigation, right to refuse, and recommending corrective actions.', '3 days', true, 'JHSC Certification Part 1', true, now(), now()),
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'Duty of Fair Representation', 'Understanding the legal duty of fair representation, avoiding arbitrary or discriminatory conduct, communicating decisions to members.', '1 day', false, NULL, true, now(), now()),
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'Winter Operations Safety', 'Seasonal safety protocols for snow removal, salting, and cold weather operations. Equipment operation and emergency procedures.', '1 day', true, 'Winter Ops Safety Certificate', true, now(), now())
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ('dd000001-0001-4000-8000-000000000001', 'Ratification Vote – PA Group CBA 2024-2028', 'Members vote to ratify the tentative agreement reached between CAPE and the Treasury Board for the PA Group.', 'ratification', 'closed', 'ratification', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'admin@cape-acep.ca', now(), now(), '2024-11-15 09:00:00-05', '2024-11-17 17:00:00-05', true, 50, 2400),
  ('dd000001-0001-4000-8000-000000000002', 'Board of Directors Election 2026', 'Election for four board positions: President, Vice-President, Secretary-Treasurer, and Member-at-Large.', 'special_vote', 'active', 'special', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'admin@cape-acep.ca', now(), now(), '2026-04-01 09:00:00-04', '2026-04-03 17:00:00-04', true, 33, 2400)
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO voting_sessions (id, title, description, type, status, meeting_type, organization_id, created_by, created_at, updated_at, start_time, end_time, requires_quorum, quorum_threshold, total_eligible_voters)
VALUES
  ('dd000001-0001-4000-8000-000000000003', 'Strike Authorization Vote – Outside Workers', 'Vote to authorize a legal strike if necessary during the Outside Workers CBA mid-term review. Requires 50%+1 of eligible voters.', 'special_vote', 'closed', 'special', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'president@cupe123.ca', now(), now(), '2026-02-10 18:00:00-05', '2026-02-10 21:00:00-05', true, 50, 320),
  ('dd000001-0001-4000-8000-000000000004', 'Bylaw Amendment – Dues Increase', 'Proposal to increase monthly dues by $5 to fund the strike fund and legal defence costs. Requires two-thirds majority.', 'special_vote', 'closed', 'special', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'president@cupe123.ca', now(), now(), '2026-01-20 19:00:00-05', '2026-01-20 21:00:00-05', true, 50, 770),
  ('dd000001-0001-4000-8000-000000000005', 'Annual General Meeting – Executive Elections', 'Election of executive officers for the 2026-2028 term.', 'special_vote', 'active', 'special', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'president@cupe123.ca', now(), now(), '2026-04-15 18:30:00-04', '2026-04-15 22:00:00-04', true, 25, 770)
ON CONFLICT (id) DO NOTHING;
...
VALUES
  (gen_random_uuid(), '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'CAPE-INC-2026-001', 'ergonomic', 'minor',
  ...
  (gen_random_uuid(), '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'CAPE-INC-2026-002', 'other', 'moderate',
  ...
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'CUPE123-INC-2026-001', 'fall', 'serious',
  ...
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'CUPE123-INC-2026-002', 'vehicle', 'moderate',
  ...
  (gen_random_uuid(), '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'CUPE123-INC-2026-003', 'exposure', 'minor',
...
-- ─────────────────────────────────────────────────────────────────────────────
-- ─────────────────────────────────────────────────────────────────────────────
-- 9. Documents (DISABLED — 'orgs' table does not exist; documents columns
--    have changed. Re-enable once document schema stabilizes.)
-- ─────────────────────────────────────────────────────────────────────────────
-- INSERT INTO orgs (id, legal_name, jurisdiction, status, created_at, updated_at)
-- VALUES
--   ('063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', 'Canadian Association of Professional Employees (CAPE-ACEP)', 'CA-ON', 'active', now(), now()),
--   ('9210418f-6a4f-4dab-a7d2-4450d581dc81', 'Canadian Union of Public Employees, Local 123', 'CA-ON', 'active', now(), now())
-- ON CONFLICT (id) DO NOTHING;

-- INSERT INTO documents (...)  -- columns org_id, title, blob_container, blob_path, sha256, classification
--   do not exist in current schema. Commented out to avoid transaction rollback.
-- See original values below for future reference:
--   CAPE: 5 documents (PA CBA, EC CBA, Anti-Harassment Policy, Financial Statements, Steward Handbook)
--   L123: 5 documents (Inside Workers CBA, Outside Workers CBA, JHSC Report, Bylaws, Budget, Winter Ops Manual)

-- INSERT INTO documents — see note above, columns don't match current schema.
...
VALUES
  (gen_random_uuid(), 'cape-user-009', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', '2025', 'Alexandre Moreau', 'ON', 'Canadian Association of Professional Employees', '119217168RR0001', '100 Queen Street', 'Ottawa', 'ON', 'K1P 1J9', 1245.60, 1185.60, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'Treasury Board of Canada Secretariat', false, false, false, 'CAPE-2025-001', 'generated', now(), now()),
  (gen_random_uuid(), 'cape-user-004', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', '2025', 'Chantal Bertrand', 'QC', 'Canadian Association of Professional Employees', '119217168RR0001', '100 Queen Street', 'Ottawa', 'ON', 'K1P 1J9', 1245.60, 1185.60, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'Treasury Board of Canada Secretariat', true, false, false, 'CAPE-2025-002', 'generated', now(), now()),
  (gen_random_uuid(), 'cape-user-007', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', '2025', 'Daniel Kim', 'ON', 'Canadian Association of Professional Employees', '119217168RR0001', '100 Queen Street', 'Ottawa', 'ON', 'K1P 1J9', 1245.60, 1185.60, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'Treasury Board of Canada Secretariat', false, false, false, 'CAPE-2025-003', 'generated', now(), now()),
  (gen_random_uuid(), 'cape-user-008', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', '2025', 'Sarah Lefebvre', 'ON', 'Canadian Association of Professional Employees', '119217168RR0001', '100 Queen Street', 'Ottawa', 'ON', 'K1P 1J9', 1245.60, 1185.60, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'Treasury Board of Canada Secretariat', false, false, false, 'CAPE-2025-004', 'generated', now(), now()),
  (gen_random_uuid(), 'cape-user-002', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', '2025', 'Emmanuelle Tremblay', 'QC', 'Canadian Association of Professional Employees', '119217168RR0001', '100 Queen Street', 'Ottawa', 'ON', 'K1P 1J9', 1245.60, 1185.60, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'Treasury Board of Canada Secretariat', true, false, false, 'CAPE-2025-005', 'generated', now(), now()),
  (gen_random_uuid(), 'cape-user-006', '063aa6d5-8b1f-4c6c-bef7-9b74f6d03bc6', '2025', 'Nadia Ouellet', 'QC', 'Canadian Association of Professional Employees', '119217168RR0001', '100 Queen Street', 'Ottawa', 'ON', 'K1P 1J9', 1245.60, 1185.60, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'Treasury Board of Canada Secretariat', true, false, false, 'CAPE-2025-006', 'generated', now(), now())
ON CONFLICT (id) DO NOTHING;

-- L123 members
INSERT INTO union_dues_receipts (id, user_id, organization_id, tax_year, member_name, member_province, union_name, union_business_number, union_address, union_city, union_province, union_postal_code, total_union_dues, regular_dues, special_assessments, initiation_fees, non_deductible_amount, cope_contributions, collection_method, employer_deducted, employer_name, is_quebec_resident, delivered_to_member, is_amendment, receipt_number, status, created_at, updated_at)
VALUES
  (gen_random_uuid(), 'user_3BP6Ienqg55Bk54Q8I3K5hh4Mk8', '9210418f-6a4f-4dab-a7d2-4450d581dc81', '2025', 'Alice Johnson', 'ON', 'Canadian Union of Public Employees, Local 123', '107886209RR0001', '21 Florence Street', 'Ottawa', 'ON', 'K2P 0W6', 936.00, 876.00, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'City of Ottawa', false, false, false, 'CUPE123-2025-001', 'generated', now(), now()),
  (gen_random_uuid(), 'user_3BP6IlC0zg9MwHJDDNn7KCcR0MV', '9210418f-6a4f-4dab-a7d2-4450d581dc81', '2025', 'Bob Smith', 'ON', 'Canadian Union of Public Employees, Local 123', '107886209RR0001', '21 Florence Street', 'Ottawa', 'ON', 'K2P 0W6', 936.00, 876.00, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'City of Ottawa', false, false, false, 'CUPE123-2025-002', 'generated', now(), now()),
  (gen_random_uuid(), 'user_3BP6IkK6vgBW4XjSTqfd3CsBjjv', '9210418f-6a4f-4dab-a7d2-4450d581dc81', '2025', 'Grace Lee', 'ON', 'Canadian Union of Public Employees, Local 123', '107886209RR0001', '21 Florence Street', 'Ottawa', 'ON', 'K2P 0W6', 936.00, 876.00, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'City of Ottawa', false, false, false, 'CUPE123-2025-003', 'generated', now(), now()),
  (gen_random_uuid(), 'user_3BSzhd4q6moCIlT3PhkWbdiAhtA', '9210418f-6a4f-4dab-a7d2-4450d581dc81', '2025', 'Marie-Claire Dubois', 'QC', 'Canadian Union of Public Employees, Local 123', '107886209RR0001', '21 Florence Street', 'Ottawa', 'ON', 'K2P 0W6', 936.00, 876.00, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'City of Ottawa', true, false, false, 'CUPE123-2025-004', 'generated', now(), now()),
  (gen_random_uuid(), 'usr-l123-005', '9210418f-6a4f-4dab-a7d2-4450d581dc81', '2025', 'Jean-Pierre Tremblay', 'ON', 'Canadian Union of Public Employees, Local 123', '107886209RR0001', '21 Florence Street', 'Ottawa', 'ON', 'K2P 0W6', 936.00, 876.00, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'City of Ottawa', false, false, false, 'CUPE123-2025-005', 'generated', now(), now()),
  (gen_random_uuid(), 'usr-l123-006', '9210418f-6a4f-4dab-a7d2-4450d581dc81', '2025', 'Fatima Al-Rashid', 'ON', 'Canadian Union of Public Employees, Local 123', '107886209RR0001', '21 Florence Street', 'Ottawa', 'ON', 'K2P 0W6', 936.00, 876.00, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'City of Ottawa', false, false, false, 'CUPE123-2025-006', 'generated', now(), now()),
  (gen_random_uuid(), 'usr-l123-007', '9210418f-6a4f-4dab-a7d2-4450d581dc81', '2025', 'David Okafor', 'ON', 'Canadian Union of Public Employees, Local 123', '107886209RR0001', '21 Florence Street', 'Ottawa', 'ON', 'K2P 0W6', 936.00, 876.00, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'City of Ottawa', false, false, false, 'CUPE123-2025-007', 'generated', now(), now()),
  (gen_random_uuid(), 'usr-l123-010', '9210418f-6a4f-4dab-a7d2-4450d581dc81', '2025', 'Priya Sharma', 'ON', 'Canadian Union of Public Employees, Local 123', '107886209RR0001', '21 Florence Street', 'Ottawa', 'ON', 'K2P 0W6', 936.00, 876.00, 60.00, 0.00, 0.00, 0.00, 'payroll_deduction', true, 'City of Ottawa', false, false, false, 'CUPE123-2025-008', 'generated', now(), now())
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ('9210418f-6a4f-4dab-a7d2-4450d581dc81', '3d7a994f-09b1-44f3-9155-329fa1d2d315', 'd1a00001-0001-4000-8000-000000000001', 'Jean-Pierre Tremblay', 'CUPE National Pension Plan', '2014-03-15', 'active', 12, 'fully_vested'),
  ('9210418f-6a4f-4dab-a7d2-4450d581dc81', '3d7a994f-09b1-44f3-9155-329fa1d2d315', 'd1a00001-0001-4000-8000-000000000002', 'Fatima Al-Rashid', 'CUPE National Pension Plan', '2019-07-01', 'active', 7, 'partially_vested'),
  ('9210418f-6a4f-4dab-a7d2-4450d581dc81', '3d7a994f-09b1-44f3-9155-329fa1d2d315', 'd1a00001-0001-4000-8000-000000000003', 'David Okafor', 'CUPE National Pension Plan', '2020-01-10', 'active', 6, 'partially_vested'),
  ('9210418f-6a4f-4dab-a7d2-4450d581dc81', '3d7a994f-09b1-44f3-9155-329fa1d2d315', 'd1a00001-0001-4000-8000-000000000004', 'Sophie Martin', 'CUPE National Pension Plan', '2017-09-20', 'active', 9, 'fully_vested'),
  ('9210418f-6a4f-4dab-a7d2-4450d581dc81', '3d7a994f-09b1-44f3-9155-329fa1d2d315', 'd1a00001-0001-4000-8000-000000000005', 'Carlos Vega', 'CUPE National Pension Plan', '2021-05-01', 'active', 5, 'partially_vested'),
  ('9210418f-6a4f-4dab-a7d2-4450d581dc81', '3d7a994f-09b1-44f3-9155-329fa1d2d315', 'd1a00001-0001-4000-8000-000000000006', 'Priya Sharma', 'CUPE National Pension Plan', '2018-11-15', 'active', 8, 'fully_vested'),
  ('9210418f-6a4f-4dab-a7d2-4450d581dc81', '3d7a994f-09b1-44f3-9155-329fa1d2d315', 'd1a00001-0001-4000-8000-000000000007', 'Liam Chen', 'CUPE National Pension Plan', '2022-03-01', 'active', 4, 'not_vested'),
  ('9210418f-6a4f-4dab-a7d2-4450d581dc81', '3d7a994f-09b1-44f3-9155-329fa1d2d315', 'd1a00001-0001-4000-8000-000000000008', 'Isabelle Nguyen', 'CUPE National Pension Plan', '2023-01-15', 'active', 3, 'not_vested')
...
VALUES
  (gen_random_uuid(), 'd1a00001-0001-4000-8000-000000000001', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'active', 'full_time', '2014-03-15', '2014-03-15', 'Senior Inspector', 'Building Services', 'bi_weekly', 82500.00, now(), now()),
  (gen_random_uuid(), 'd1a00001-0001-4000-8000-000000000002', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'active', 'full_time', '2019-07-01', '2019-07-01', 'Program Coordinator', 'Community Services', 'bi_weekly', 71200.00, now(), now()),
  (gen_random_uuid(), 'd1a00001-0001-4000-8000-000000000003', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'active', 'full_time', '2020-01-10', '2020-01-10', 'Equipment Operator', 'Roads and Drainage', 'bi_weekly', 62800.00, now(), now()),
  (gen_random_uuid(), 'd1a00001-0001-4000-8000-000000000004', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'active', 'full_time', '2017-09-20', '2017-09-20', 'Administrative Assistant', 'City Clerk''s Office', 'bi_weekly', 58400.00, now(), now()),
  (gen_random_uuid(), 'd1a00001-0001-4000-8000-000000000005', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'active', 'full_time', '2021-05-01', '2021-05-01', 'Parks Maintenance Worker', 'Parks and Facilities', 'bi_weekly', 55600.00, now(), now()),
  (gen_random_uuid(), 'd1a00001-0001-4000-8000-000000000006', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'active', 'full_time', '2018-11-15', '2018-11-15', 'Building Maintenance Technician', 'Building Operations', 'bi_weekly', 68900.00, now(), now()),
  (gen_random_uuid(), 'd1a00001-0001-4000-8000-000000000007', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'active', 'full_time', '2022-03-01', '2022-03-01', 'IT Support Analyst', 'Information Technology', 'bi_weekly', 64500.00, now(), now()),
  (gen_random_uuid(), 'd1a00001-0001-4000-8000-000000000008', '9210418f-6a4f-4dab-a7d2-4450d581dc81', 'active', 'full_time', '2023-01-15', '2023-01-15', 'Library Technician', 'Ottawa Public Library', 'bi_weekly', 52100.00, now(), now())
ON CONFLICT DO NOTHING;
