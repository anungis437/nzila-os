...
VALUES
  ('bb000001-0001-4000-8000-000000000001', 'c09173ad-5ba4-498e-a483-b371fb5e248e',
...
VALUES
  ('cc000001-0001-4000-8000-000000000001', 'c09173ad-5ba4-498e-a483-b371fb5e248e', '3ea05964-824e-4e5a-a22f-4111c6f0f774', 'National Capital Region', 'Grievances – Classification', true, 15, 6, now(), now()),
  ('cc000001-0001-4000-8000-000000000002', 'c09173ad-5ba4-498e-a483-b371fb5e248e', 'cf3c73a8-3424-4c41-8a4e-bf5e6dcfd3a9', 'National Capital Region', 'Harassment and Discipline', true, 12, 4, now(), now()),
  ('cc000001-0001-4000-8000-000000000003', 'c09173ad-5ba4-498e-a483-b371fb5e248e', 'b45b99ed-fe83-4166-8b98-e4a3246e0131', 'Western Canada', 'Health & Safety', true, 10, 3, now(), now()),
  ('cc000001-0001-4000-8000-000000000004', 'c09173ad-5ba4-498e-a483-b371fb5e248e', 'df93b6d0-f9b4-4689-a75b-360a8a95c882', 'Quebec', 'Pay and Benefits', true, 12, 5, now(), now())
ON CONFLICT (id) DO NOTHING;
...
VALUES
  (gen_random_uuid(), 'c09173ad-5ba4-498e-a483-b371fb5e248e', 'Steward Fundamentals', 'Introduction to steward duties, rights, and responsibilities under the collective agreement. Covers duty of fair representation, grievance intake procedures, and time limits.', '2 days', true, 'CAPE Steward Certificate', true, now(), now()),
  (gen_random_uuid(), 'c09173ad-5ba4-498e-a483-b371fb5e248e', 'Advanced Grievance Handling', 'In-depth grievance investigation, evidence gathering, preparation for hearings, and settlement negotiation techniques.', '3 days', true, 'Advanced Grievance Certificate', true, now(), now()),
  (gen_random_uuid(), 'c09173ad-5ba4-498e-a483-b371fb5e248e', 'Workplace Harassment Prevention', 'Recognizing, responding to, and preventing workplace harassment and violence. Includes trauma-informed approaches.', '1 day', false, NULL, true, now(), now()),
  (gen_random_uuid(), 'c09173ad-5ba4-498e-a483-b371fb5e248e', 'Collective Bargaining Essentials', 'Preparation for bargaining: proposal development, costing, negotiation strategies, and ratification processes.', '5 days', true, 'Bargaining Team Certificate', true, now(), now()),
...
VALUES
  (gen_random_uuid(), 'c09173ad-5ba4-498e-a483-b371fb5e248e', 'CAPE-INC-2026-001', 'ergonomic', 'minor',
  ...
  (gen_random_uuid(), 'c09173ad-5ba4-498e-a483-b371fb5e248e', 'CAPE-INC-2026-002', 'other', 'moderate',
...
VALUES
  ('c09173ad-5ba4-498e-a483-b371fb5e248e', 'Canadian Association of Professional Employees (CAPE-ACEP)', 'CA-ON', 'active', now(), now()),
...
VALUES
  ...
  (gen_random_uuid(), '4a20966a-2f17-46b5-9b84-b3efea57b50a', '4a20966a-2f17-46b5-9b84-b3efea57b50a', 'health_safety', 'JHSC Annual Report 2025', 'documents', 'cupe123/reports/CUPE123-JHSC-Report-2025.pdf', 'application/pdf', 'seed-placeholder-sha256-008', 'system-seed', 'internal', 'CUPE123-JHSC-Report-2025.pdf', 'Joint Health and Safety Committee annual report covering inspections, incidents, and recommendations.', false, 'member', now(), now()),
  (gen_random_uuid(), '4a20966a-2f17-46b5-9b84-b3efea57b50a', '4a20966a-2f17-46b5-9b84-b3efea57b50a', 'governance', 'CUPE Local 123 Bylaws (Amended 2025)', 'documents', 'cupe123/governance/CUPE123-Bylaws-2025.pdf', 'application/pdf', 'seed-placeholder-sha256-009', 'system-seed', 'public', 'CUPE123-Bylaws-2025.pdf', 'Local bylaws as amended at the 2025 Annual General Meeting.', false, 'public', now(), now()),
  (gen_random_uuid(), '4a20966a-2f17-46b5-9b84-b3efea57b50a', '4a20966a-2f17-46b5-9b84-b3efea57b50a', 'financial', 'CUPE Local 123 Budget 2026', 'documents', 'cupe123/financial/CUPE123-Budget-2026.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'seed-placeholder-sha256-010', 'system-seed', 'confidential', 'CUPE123-Budget-2026.xlsx', 'Approved operating budget for 2026 including strike fund allocation.', true, 'executive', now(), now()),
  (gen_random_uuid(), '4a20966a-2f17-46b5-9b84-b3efea57b50a', '4a20966a-2f17-46b5-9b84-b3efea57b50a', 'training', 'Winter Operations Safety Manual', 'documents', 'cupe123/training/CUPE123-Winter-Ops-Safety-2026.pdf', 'application/pdf', 'seed-placeholder-sha256-011', 'system-seed', 'internal', 'CUPE123-Winter-Ops-Safety-2026.pdf', 'Safety procedures for winter operations including snow removal and salting.', false, 'member', now(), now())
ON CONFLICT (id) DO NOTHING;
