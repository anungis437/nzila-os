-- Migration: Create pilot_enrollments and pilot_milestones tables
-- Required by: /api/pilot/current, /dashboard/pilot
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_pilot_enrollments_org ON pilot_enrollments(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_pilot_milestones_org ON pilot_milestones(organization_id);
