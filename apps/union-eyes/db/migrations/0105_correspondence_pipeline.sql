...
CREATE TABLE IF NOT EXISTS correspondence (
  ...
  drafted_by          TEXT NOT NULL REFERENCES profiles(user_id),
  assigned_signer_id  TEXT REFERENCES profiles(user_id),
  approved_by         TEXT REFERENCES profiles(user_id),
  approved_at         TIMESTAMPTZ,
  signature_id        UUID,
  signed_at           TIMESTAMPTZ,
  signed_by           TEXT REFERENCES profiles(user_id),
  dispatched_at       TIMESTAMPTZ,
  dispatched_by       TEXT REFERENCES profiles(user_id),
...
CREATE TABLE IF NOT EXISTS correspondence_audit_trail (
  ...
  actor_user_id     TEXT NOT NULL REFERENCES profiles(user_id),
