  ...
  const orgSections = [
    {
      ...
      items: [
        ...
        { href: `/${locale}/dashboard/health-safety`, icon: <Shield size={16} />, label: t('sidebar.healthSafety'), roles: [...unionAll, mgmt] },
    ...
    },
    {
      ...
      items: [
        ...
        { href: `/${locale}/calendar`, icon: <Calendar size={16} />, label: t('calendar.title'), roles: ["member", "steward", "officer", "admin", mgmt] },
      ],
    },
    {
