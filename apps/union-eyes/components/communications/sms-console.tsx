/**
 * SMS Communications Console (client component)
 * Extracted from page for server-side auth wrapper
 */
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {stats.messagesSent > 0
                ? ((stats.messagesFailed / stats.messagesSent) * 100).toFixed(1)
                : '0.0'}% failure rate
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              ${stats.messagesSent > 0
                ? (stats.totalCost / stats.messagesSent).toFixed(4)
                : '0.0000'} per message
            </p>
          </CardContent>
        </Card>
