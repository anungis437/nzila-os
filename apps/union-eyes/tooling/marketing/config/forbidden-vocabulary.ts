...
const startupSaas: ForbiddenTerm[] = [
  ...
  // Phase 3: Conventions & Federated Governance — organizational framing guards
  ...
  // Phase 4: Buyer-facing SaaS-positioning guards (organizational infrastructure framing)
  { term: "operating system for unions", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure for unions" },
  ...
  { term: "module-level entitlements", severity: "hard-fail", category: "startup-saas", suggestion: "contractual scope | organizational licensing" },
  { term: "request a demo", severity: "hard-fail", category: "startup-saas", suggestion: "request an organizational briefing | request executive walkthrough" },
  { term: "book a demo", severity: "hard-fail", category: "startup-saas", suggestion: "book an organizational briefing" },
...
const surveillanceAi: ForbiddenTerm[] = [
  ...
  { term: "autonomous organizational reasoning", severity: "hard-fail", category: "surveillance-ai", suggestion: "reviewer-assisted organizational reasoning under human oversight" },
  ...
  { term: "organizational analytics", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational intelligence | continuity-aware reporting" },
  { term: "leadership analytics", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational intelligence" },
  { term: "organizational scoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "reviewer-assisted organizational intelligence" },
...
// internal runtime surfaces). The narrative posture is organizational from the
...
// Observability surfaces must answer "how did this organizational state emerge?" —
// NEVER "how do we optimize organizational behaviour?". The following compound
...
const observabilityGuards: ForbiddenTerm[] = [
  ...
  { term: "organizational ranking", severity: "hard-fail", category: "observability-guard" },
...
const trustProcurementRuntime: ForbiddenTerm[] = [
  { term: "transformation platform", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | continuity overlay" },
  { term: "platform dominance", severity: "hard-fail", category: "startup-saas" },
  { term: "organizational monitoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational observability of record | inspectable operational posture" },
...
// Workstream K: Organizational Topology UX guards.
...
const topologyUx: ForbiddenTerm[] = [
  ...
  { term: "influence visualization", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational topology | inspectable organizational relationships" },
  { term: "social topology", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational topology" },
  { term: "social graph", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational topology | affiliation structure" },
  ...
  { term: "organizational monitoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational observability of record" },
  { term: "topology optimization", severity: "hard-fail", category: "surveillance-ai", suggestion: "inspectable organizational topology" },
  { term: "enterprise hierarchy dashboard", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational hierarchy view" },
  { term: "AI topology", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational topology under reviewer oversight" },
  { term: "graph theater", severity: "hard-fail", category: "surveillance-ai", suggestion: "inspectable organizational topology" },
...
const chronologyUx: ForbiddenTerm[] = [
  ...
  { term: "organizational scoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "preserved organizational records | governance chronology of record" },
...
const ontologyReconciliation: ForbiddenTerm[] = [
  ...
  // OCI doctrine: "organizational intelligence" is the rewarded posture (page
  // title in i18n). Surveillance creep is fenced via "organizational scoring",
  // "organizational monitoring", "organizational analytics" below.
  { term: "topology analytics", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational structure of record" },
  ...
  { term: "organizational surveillance", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational observability of record" },
  ...
  { term: "influence mapping", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational topology | inspectable organizational relationships" },
  { term: "predictive governance", severity: "hard-fail", category: "surveillance-ai", suggestion: "governance chronology of record" },
  { term: "organizational scoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "inspectable organizational state" },
...
// explainability overlays into more organizational surfaces, these compound
...
const wave2DepthConvergence: ForbiddenTerm[] = [
  ...
  { term: "topology scoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational structure of record" },
  ...
  { term: "memory scoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "preserved organizational record" },
...
// keeps the cognition layer organizational rather than predictive.
const wave3ContinuityCognition: ForbiddenTerm[] = [
  ...
  { term: "organizational risk scoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational continuity of record" },
  { term: "succession scoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "succession pathway of record" },
  { term: "memory-gap scoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational memory gap (presence count)" },
  ...
  { term: "behavioural continuity", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational continuity (structural)" },
...
// Wave 4 — Organizational language, label & surface convergence.
...
// provenance-stamped, governance-safe organizational vocabulary.
const wave4LanguageConvergence: ForbiddenTerm[] = [
  ...
  // OCI doctrine: "organizational intelligence" is the rewarded posture; only
  // surveillance compounds (monitoring/scoring/analytics) stay fenced below.
  { term: "organizational monitoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational visibility (read-only, provenance-stamped)" },
...
// Wave 5 — Quebec & multilingual organizational parity guards.
...
// reasoning, and read-only organizational visibility.
const wave6RuntimeCockpit: ForbiddenTerm[] = [
  ...
  { term: "organizational cockpit", severity: "hard-fail", category: "startup-saas", suggestion: "organizational coordination surface" },
  // Telemetry posture (extends Wave 1's operational-telemetry-posture)
  { term: "organizational telemetry", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational visibility of record (read-only, provenance-stamped)" },
  ...
  { term: "organizational analytics", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational visibility of record" },
  ...
  { term: "organizational orchestration", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational coordination (reviewer-led)" },
  // Admin / onboarding cockpit posture
  { term: "enterprise administration", severity: "hard-fail", category: "startup-saas", suggestion: "organizational stewardship | coexistence-aware administration" },
...
// Wave 7 — Organizational Deployment Readiness & Operationalization.
...
const wave7DeploymentReadiness: ForbiddenTerm[] = [
  ...
  { term: "tenant provisioning", severity: "hard-fail", category: "startup-saas", suggestion: "organizational provisioning | federation-aware provisioning" },
  { term: "executive administration", severity: "hard-fail", category: "startup-saas", suggestion: "organizational stewardship | stewardship-grade administration" },
  { term: "organizational engineering", severity: "hard-fail", category: "startup-saas", suggestion: "organizational lifecycle stewardship | continuity-aware lifecycle" },
];

// Wave 8 — Organizational Observability & Continuity UX Maturity.
...
// coordination visibility, and archival-modern organizational UX.
const wave8ObservabilityUxMaturity: ForbiddenTerm[] = [
  // Dashboard posture drift on observability surfaces
  { term: "observability dashboard", severity: "hard-fail", category: "startup-saas", suggestion: "organizational observability workspace | governance-safe visibility surface" },
  { term: "organizational dashboard", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity workspace | governance-safe visibility surface" },
  ...
  { term: "topology dashboard", severity: "hard-fail", category: "startup-saas", suggestion: "topology workspace | organizational structure surface" },
  ...
  { term: "observability monitoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational observability of record (read-only)" },
  ...
  { term: "graph analytics", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational topology of record | inspectable organizational structure" },
  { term: "network analytics", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational topology of record | inspectable affiliation structure" },
  { term: "influence graph", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational topology | inspectable organizational relationships" },
  { term: "node graph", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational structure panel | lineage-linked continuity" },
  ...
  { term: "live monitoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "read-only organizational visibility | chronology-linked visibility" },
...
// Wave 9 — Trust, Procurement & Organizational Assurance Industrialization.
...
// organizational assurance, continuity-native assurance evidence, provenance-
// aware trust infrastructure, chronology-integrity guarantees, explainable
// organizational assurance, governance-safe observability assurances, and
// archival-modern organizational assurance UX.
const wave9AssuranceIndustrialization: ForbiddenTerm[] = [
  // Compliance-theater / audit-cockpit posture drift
  { term: "compliance theater", severity: "hard-fail", category: "startup-saas", suggestion: "procurement-grade organizational assurance | continuity-native assurance evidence" },
  { term: "compliance portal", severity: "hard-fail", category: "startup-saas", suggestion: "organizational trust surface | procurement-grade assurance workspace" },
  { term: "audit cockpit", severity: "hard-fail", category: "startup-saas", suggestion: "organizational evidence workspace | procedural assurance surface" },
  { term: "enterprise audit cockpit", severity: "hard-fail", category: "startup-saas", suggestion: "organizational assurance workspace | continuity-native evidence surface" },
  // Assurance / trust / procurement / stewardship dashboard posture drift
  { term: "assurance dashboard", severity: "hard-fail", category: "startup-saas", suggestion: "organizational assurance workspace | procurement-grade assurance surface" },
  { term: "trust dashboard", severity: "hard-fail", category: "startup-saas", suggestion: "organizational trust workspace | continuity-aware trust surface" },
  { term: "procurement dashboard", severity: "hard-fail", category: "startup-saas", suggestion: "procurement-grade assurance workspace | organizational procurement surface" },
  { term: "stewardship dashboard", severity: "hard-fail", category: "startup-saas", suggestion: "organizational stewardship workspace | continuity-aware stewardship surface" },
  ...
  { term: "procurement analytics", severity: "hard-fail", category: "surveillance-ai", suggestion: "procurement evidence of record | organizational procurement chronology" },
  ...
  { term: "assurance monitoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational assurance of record (read-only)" },
  { term: "trust monitoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational trust of record (read-only)" },
  { term: "organizational monitoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "organizational visibility of record (read-only) | governance-safe organizational visibility" },
  ...
  { term: "assurance scoring", severity: "hard-fail", category: "surveillance-ai", suggestion: "assurance evidence of record | explainable organizational assurance" },
  ...
  { term: "executive oversight", severity: "hard-fail", category: "startup-saas", suggestion: "organizational stewardship | governance-of-record visibility" },
...
// only as "organizational continuity infrastructure." Rewarded substitutes lean
// on organizational continuity infrastructure, continuity substrate, procedural
// continuity infrastructure, organizational stewardship, and archival-grade
...
const wave10DefinitiveCategoryConsolidation: ForbiddenTerm[] = [
  ...
  { term: "governance platform", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | continuity substrate" },
  { term: "enterprise governance platform", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | procedural continuity infrastructure" },
  { term: "governance software", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | governance-safe organizational substrate" },
  { term: "governance application", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | continuity substrate" },
  { term: "governance app", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | continuity substrate" },
  { term: "governance tooling", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | governance-safe organizational substrate" },
  { term: "enterprise governance tooling", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | procedural continuity infrastructure" },
  // SaaS-governance / SaaS-suite posture drift
  { term: "SaaS governance", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure" },
  { term: "organizational SaaS", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | continuity substrate" },
  { term: "operational SaaS", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | continuity-native operationalization" },
  { term: "organizational software suite", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | organizational substrate" },
  ...
  { term: "enterprise workflow", severity: "hard-fail", category: "startup-saas", suggestion: "organizational procedural continuity | continuity-native coordination" },
  ...
  { term: "observability software", severity: "hard-fail", category: "startup-saas", suggestion: "organizational observability infrastructure | governance-safe organizational visibility" },
  ...
  { term: "case-management platform", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | continuity substrate" },
  { term: "case-management infrastructure", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | continuity substrate" },
  { term: "compliance tooling", severity: "hard-fail", category: "startup-saas", suggestion: "procurement-grade organizational assurance | continuity-native assurance evidence" },
  // Transformation-consulting / modernization-platform posture drift
  { term: "digital transformation", severity: "hard-fail", category: "startup-saas", suggestion: "coexistence-safe operationalization | continuity-safe organizational integration" },
  { term: "digital-transformation tooling", severity: "hard-fail", category: "startup-saas", suggestion: "coexistence-safe operationalization | continuity-safe organizational integration" },
  { term: "transformation consulting", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity stewardship | reviewer-led continuity operationalization" },
  { term: "modernization platform", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity infrastructure | continuity-native modernization (reviewer-led)" },
];

// ---------------------------------------------------------------------------
// Wave 11 — Organizational Livedness & Continuity Saturation
// ---------------------------------------------------------------------------
...
// frames implicitly deny the organizational continuity residue, stewardship
...
// inherited organizational state, continuity residue, stewardship lineage,
// procedural history, and reviewer-inhabited continuity substrate.
const wave11OrganizationalLivednessSaturation: ForbiddenTerm[] = [
  // Greenfield-deployment drift (denies organizational continuity residue)
  ...
  { term: "fresh install", severity: "hard-fail", category: "startup-saas", suggestion: "inherited organizational state | continuity-residue-bearing runtime" },
  { term: "greenfield deployment", severity: "hard-fail", category: "startup-saas", suggestion: "coexistence-safe operationalization atop inherited organizational state" },
  // Empty / sparse / under-inhabited drift (denies organizational inhabitation)
  ...
  { term: "empty tenant", severity: "hard-fail", category: "startup-saas", suggestion: "reviewer-inhabited continuity substrate | stewardship-lineage-bearing organizational tenancy" },
  ...
  { term: "blank slate", severity: "hard-fail", category: "startup-saas", suggestion: "inherited organizational state | continuity-residue-bearing substrate" },
  { term: "clean slate", severity: "hard-fail", category: "startup-saas", suggestion: "inherited organizational state | continuity-residue-bearing substrate" },
  // Demo / sandbox / trial drift (denies organizational production-grade inhabitation)
  { term: "demo environment", severity: "hard-fail", category: "startup-saas", suggestion: "reviewer-inhabited continuity substrate | organizational reviewer-led continuity instance" },
  { term: "demo tenant", severity: "hard-fail", category: "startup-saas", suggestion: "reviewer-inhabited organizational tenancy | stewardship-lineage-bearing instance" },
  { term: "sandbox tenant", severity: "hard-fail", category: "startup-saas", suggestion: "reviewer-inhabited organizational tenancy | continuity-residue-bearing instance" },
  { term: "trial environment", severity: "hard-fail", category: "startup-saas", suggestion: "reviewer-inhabited continuity substrate | organizational reviewer-led continuity instance" },
  // Placeholder / template-tenant drift (denies inherited procedural history)
  { term: "placeholder tenant", severity: "hard-fail", category: "startup-saas", suggestion: "stewardship-lineage-bearing organizational tenancy | inherited continuity substrate" },
  ...
  { term: "starter template", severity: "hard-fail", category: "startup-saas", suggestion: "inherited continuity substrate | procedural-history-bearing organizational baseline" },
  { term: "starter kit", severity: "hard-fail", category: "startup-saas", suggestion: "inherited continuity substrate | procedural-history-bearing organizational baseline" },
  ...
  // Toy / vanilla / pristine / stock-config drift (denies lived organizational configuration history)
  { term: "toy deployment", severity: "hard-fail", category: "startup-saas", suggestion: "reviewer-inhabited continuity substrate | organizational reviewer-led continuity instance" },
  { term: "vanilla deployment", severity: "hard-fail", category: "startup-saas", suggestion: "stewardship-lineage-bearing organizational instance | inherited continuity substrate" },
  { term: "pristine deployment", severity: "hard-fail", category: "startup-saas", suggestion: "stewardship-lineage-bearing organizational instance | continuity-residue-bearing runtime" },
  { term: "stock configuration", severity: "hard-fail", category: "startup-saas", suggestion: "stewardship-lineage-bearing organizational configuration | inherited governance state" },
];
...
// carry-forward, organizational-memory continuity, chronology-linked continuity,
...
// continuity, inherited organizational state, and continuity-native accumulation.
const wave12LongitudinalAccumulation: ForbiddenTerm[] = [
  ...
  { term: "current operational state", severity: "hard-fail", category: "startup-saas", suggestion: "historically accumulated continuity | inherited organizational state preserved through successive governance epochs" },
  ...
  // B. Live / real-time timeline drift (denies organizational permanence)
...
// helpers rather than continuity-preserved organizational surfaces. Rewarded
// substitutes lean on continuity-preserved transition, governance-era continuity,
// organizational-memory layering, stewardship-linked continuity, chronology-linked
// inheritance, coexistence continuity, federation continuity, procedural carry-
// forward, archival continuity texture, continuity-aware organizational state,
// inherited continuity, historically accumulated continuity, continuity-
// preservation layering, governance-linked procedural continuity, organizationally
...
const wave13UniversalSurfaceSaturation: ForbiddenTerm[] = [
  // A. Helper-grade utility drift (denies organizational saturation)
  { term: "helper dashboard", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | continuity-preservation layering" },
  { term: "utility panel", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | organizational-memory layering" },
  { term: "helper tool", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | continuity-preserved procedural surface" },
  { term: "helper module", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | continuity-preserved organizational surface" },
  { term: "app helper", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | organizationally inhabited infrastructure surface" },
  // B. Operational sidebar / panel drift
  { term: "operational sidebar", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preservation overlay | organizational-memory overlay" },
  { term: "control sidebar", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preservation overlay | organizational-memory overlay" },
  { term: "operational helper", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | continuity-preserved procedural surface" },
  { term: "activity helper", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | procedural carry-forward surface" },
  ...
  { term: "admin utility", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | organizational-memory layering" },
  { term: "management utility", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | stewardship-linked continuity surface" },
  { term: "runtime utility", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | continuity-preservation layering" },
  { term: "operational utility", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | continuity-preservation layering" },
  { term: "utility module", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | continuity-preserved organizational surface" },
  // E. Operational / app / feature module drift
  { term: "operational module", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational surface | organizational-memory layering" },
  { term: "app module", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational surface | organizationally inhabited infrastructure surface" },
  { term: "feature module", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational surface | organizationally inhabited infrastructure surface" },
  // F. Operational widget / task-assistant / support-tooling drift
  { term: "operational widget", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preservation overlay | organizational-memory overlay" },
  { term: "task assistant", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | procedural carry-forward surface" },
  { term: "support tooling", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-aware organizational surface | continuity-preservation layering" },
];
...
// organizational space. Rewarded substitutes lean on continuity persistence,
// chronology persistence, stewardship persistence, coexistence continuity,
// organizational-memory persistence, continuity-preserved rendering, archival
// continuity atmosphere, governance-era continuity, continuity-native flow,
// phenomenologically organizational framing, continuity-preserved organizational
// state, continuity-aware persistence, inherited continuity, procedurally
// accumulated continuity, organizational permanence, continuity-linked
...
const wave14RuntimePhenomenology: ForbiddenTerm[] = [
  ...
  { term: "application shell", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational space | organizational permanence" },
  { term: "app shell", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational space | organizational permanence" },
  { term: "runtime shell", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved runtime atmosphere | organizational permanence" },
  { term: "interface layer", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational surface | continuity-linked rendering" },
  // B. State-mechanics drift (exposes runtime state machines)
  { term: "app state", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational state | continuity-aware persistence" },
  { term: "route state", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational state | continuity-native flow" },
  { term: "navigation state", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational state | continuity-native flow" },
  { term: "application state", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational state | inherited continuity" },
  ...
  { term: "application loading", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved rendering | organizational-memory persistence" },
  ...
  { term: "interaction layer", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-native interaction rhythm | continuity-preserved organizational surface" },
  // E. Management posture drift (exposes client-side management semantics)
  { term: "client-side management", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational state | continuity-aware persistence" },
  { term: "UI management", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational surface | continuity-linked rendering" },
  { term: "session management", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational state | inherited continuity" },
  // F. Context-scope / runtime-context / navigation drift
  { term: "application context", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational context | inherited continuity" },
  { term: "runtime context", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational context | continuity-aware persistence" },
  { term: "feature context", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational context | governance-era continuity" },
  { term: "operational context panel", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preservation overlay | organizational-memory overlay" },
  { term: "application runtime", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved runtime atmosphere | organizational permanence" },
...
// organizational infrastructure. Rewarded substitutes lean on continuity
// survivability, governance-preserved recovery, continuity-preserved rollback,
// coexistence durability, federation continuity durability, organizational
...
// organizational continuity persistence, coexistence-safe operational
...
const wave15OperationalInevitability: ForbiddenTerm[] = [
  ...
  { term: "service availability", severity: "hard-fail", category: "startup-saas", suggestion: "continuity survivability | organizational continuity persistence" },
  ...
  { term: "operations center", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational surface | organizational continuity persistence" },
  ...
  { term: "ops center", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved organizational surface | organizational continuity persistence" },
  { term: "platform operations", severity: "hard-fail", category: "startup-saas", suggestion: "organizational continuity persistence | continuity-preserved operational evolution" },
  // E. Infrastructure-management / control drift
  { term: "infrastructure operations", severity: "hard-fail", category: "startup-saas", suggestion: "continuity-preserved operational evolution | organizational continuity persistence" },
  { term: "infrastructure management", severity: "hard-fail", category: "startup-saas", suggestion: "continuity durability | organizational continuity persistence" },
...
// posture into surfaces that should read as organizationally inhabited
...
// continuity, organizationally inhabited continuity, continuity survivability,
...
const wave16RealContinuityAccumulation: ForbiddenTerm[] = [
  ...
  { term: "sample organizational history", severity: "hard-fail", category: "startup-saas", suggestion: "actual organizational-memory accumulation | historically inhabited continuity" },
  ...
  { term: "synthetic continuity state", severity: "hard-fail", category: "startup-saas", suggestion: "actual continuity state | organizationally inhabited continuity" },
  ...
  { term: "fabricated continuity", severity: "hard-fail", category: "startup-saas", suggestion: "actual continuity residue | organizationally inhabited continuity" },
  ...
  { term: "illustrative continuity", severity: "hard-fail", category: "startup-saas", suggestion: "actual continuity residue | organizationally inhabited continuity" },
  ...
  { term: "prototype continuity state", severity: "hard-fail", category: "startup-saas", suggestion: "actual continuity state | organizationally inhabited continuity" },
...
// continuity, governance-preserved constitutional continuity, organizationally
...
const wave17ConstitutionalCategoryFormation: ForbiddenTerm[] = [
  ...
  // C. Governance-tooling / module / engine / organizational-governance-tooling posture
  ...
  { term: "organizational governance tooling", severity: "hard-fail", category: "startup-saas", suggestion: "constitutional continuity infrastructure | organizationally inhabited constitutional continuity" },
...
export const FORBIDDEN_VOCABULARY: ForbiddenTerm[] = [
  ...
  ...wave11OrganizationalLivednessSaturation,
