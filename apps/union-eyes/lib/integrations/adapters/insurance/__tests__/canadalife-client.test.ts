...
import { CanadaLifeClient } from '../../../adapters/insurance/canadalife-client';
...
const makeClient = (over: Record<string, unknown> = {}) =>
  new CanadaLifeClient({ clientId: 'cid', clientSecret: 'secret', policyGroupId: 'pg1', refreshToken: 'rt', environment: 'sandbox', ...over });

describe('CanadaLifeClient', () => {
  beforeEach(() => {
    queue.length = 0;
