...
const CONTINUITY_CONFIDENCE: LikertQuestion[] = [
  ...
  },
  {
    ...
    weights: { institutional_continuity: 0.6, operational_memory: 0.3, trust_debt: 0.4 },
    scale: CONFIDENCE_SCALE,
    allowNote: true,
  ...
  },
  {
    ...
    type: 'likert_5',
    prompt:
      'Governance authorities can explain and defend major data-sharing decisions using explicit institutional mandate and continuity rationale.',
    weights: { institutional_continuity: 0.5, governance_fragility: 0.4, trust_debt: 0.6 },
    scale: CONFIDENCE_SCALE,
    allowNote: true,
    rationale:
      'Senses governance confidence in authority explainability for trust-sensitive continuity decisions.',
    intelligence: {
      modalityRole: 'confidence_sensing',
...
const STRUCTURAL_CONTINUITY: MultipleChoiceQuestion[] = [
  ...
  },
  {
    ...
    weights: { institutional_continuity: 0.3, operational_memory: 0.3, trust_debt: 0.4 },
  ...
  },
  {
    ...
    type: 'multiple_choice',
    prompt:
      'When trust-sensitive governance choices are made, which authority pathway most often determines the final decision?',
    weights: { institutional_continuity: 0.3, governance_fragility: 0.3, trust_debt: 0.5 },
    rationale:
      'Surfaces the practical governance authority topology behind trust-sensitive continuity decisions.',
    options: [
      {
        value: 'documented_mandate',
        label: 'Documented mandate path with explicit rationale and record',
        score: 1.0,
      },
      {
        value: 'committee_alignment',
        label: 'Committee alignment with partial documentation',
        score: 0.75,
      },
      {
        value: 'executive_override',
        label: 'Executive override under time pressure',
        score: 0.3,
      },
      {
        value: 'ad_hoc_negotiation',
        label: 'Ad-hoc negotiation without stable authority pathway',
        score: 0.1,
      },
    ],
    allowNote: true,
