...
export const SECTOR_BASELINES: readonly SectorBaseline[] = [
  ...
  },
  {
    ...
    description: {
      'en-CA':
        'Municipal councils, administrative offices, and standing committees whose continuity touches bylaw history, council precedent, and inter-departmental institutional memory.',
    },
    governanceShape: 'representative-elected',
