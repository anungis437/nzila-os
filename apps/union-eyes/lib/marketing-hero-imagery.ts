...
export const heroImagery = {
  ...
  governance: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1920&q=80&auto=format', // Updated to a distinct, high-contrast Unsplash image
  ...
  conventions: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?w=1920&q=80&auto=format', // Convention center theme
} as const;
