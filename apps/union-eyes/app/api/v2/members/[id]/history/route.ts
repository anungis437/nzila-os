/**
 * Member history timeline (v2)
 * GET /api/v2/members/[id]/history — list history events for a member
 * PATCH /api/v2/members/[id]/history — update a history event visibility
 * DELETE /api/v2/members/[id]/history — soft-remove a history event
 */
