/**
 * SCIM 2.0 Users endpoint (v2)
 * GET /api/v2/scim/v2/[organizationId]/Users — list users in SCIM format
 * POST /api/v2/scim/v2/[organizationId]/Users — provision a new user
 */
