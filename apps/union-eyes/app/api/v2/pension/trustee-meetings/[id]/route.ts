...
export const GET = withApi(
  {
    ...
    openapi: {
      tags: ['Pension'],
      summary: 'GET trustee meeting by ID',
      description: 'Get a single trustee meeting',
    },
  },
  async ({ request }) => {
...
export const PATCH = withApi(
  {
    ...
    openapi: {
      tags: ['Pension'],
      summary: 'PATCH trustee meeting',
      description: 'Update a trustee meeting',
    },
  },
  async ({ request }) => {
...
export const DELETE = withApi(
  {
    ...
    openapi: {
      tags: ['Pension'],
      summary: 'DELETE trustee meeting',
      description: 'Delete a trustee meeting',
    },
  },
  async ({ request }) => {
