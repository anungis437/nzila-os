/**
 * Integration extensions endpoint (v2)
 * GET /api/v2/extensions/[id] — get a single integration config
 * PATCH /api/v2/extensions/[id] — update integration config
 * DELETE /api/v2/extensions/[id] — remove integration
 */
