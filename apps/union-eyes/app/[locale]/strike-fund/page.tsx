...
export default function StrikeFundDashboardPage() {
  ...
  const t = useTranslations('strikeFund.dashboard');
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="font-semibold text-lg">{t("fundHealth")}</h3>
            <p className="text-sm text-muted-foreground">
              {t("fundHealthDescription", { weeks: weeksRemaining })}
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">{t("weeklyDisbursements")}</p>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">{t("activeRecipients")}</p>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>{t("tableHeaderWeeklyAmount")}</TableHead>
              <TableHead>{t("tableHeaderDependents")}</TableHead>
              <TableHead>{t("tableHeaderStatus")}</TableHead>
              <TableHead>{t("tableHeaderApplied")}</TableHead>
              <TableHead>{t("tableHeaderApproved")}</TableHead>
          ...
          <TableBody>
            {applications.map((app) => (
              ...
              >
                ...
                <TableCell>
                  <Button variant="ghost" size="sm">{t("viewAction")}</Button>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
