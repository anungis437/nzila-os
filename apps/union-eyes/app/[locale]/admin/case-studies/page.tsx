...
export default async function AdminCaseStudiesPage({ params, searchParams }: AdminCaseStudiesPageProps & { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="container mx-auto py-8 space-y-8">
      ...
      <div className="flex items-start justify-between">
        ...
        <Button asChild>
          <Link href={`/${locale}/admin/case-studies/new`}>
              ...
              {studies.map((study) => (
                <TableRow key={study.id}>
                  <TableCell className="font-medium">
                    <Link 
                      href={`/${locale}/admin/case-studies/${study.slug}/edit`}
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      <Button variant="ghost" size="sm" asChild>
                        <Link href={`/${locale}/case-studies/${study.slug}`} target="_blank">
                          <Eye className="h-4 w-4" />
                        </Link>
                      </Button>
                      <Button variant="ghost" size="sm" asChild>
                        <Link href={`/${locale}/admin/case-studies/${study.slug}/edit`}>
