      ...
      <MarketingHeroSection
        ...
        cta={
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link href={`/${locale}/organizational-continuity-risk?context=conference`} className="inline-flex items-center justify-center px-7 py-3.5 bg-white/15 text-white font-semibold rounded-xl border border-white/30 hover:bg-white/25 transition-all">
              {copy.ctaPilot}
            </Link>
          </div>
        }
