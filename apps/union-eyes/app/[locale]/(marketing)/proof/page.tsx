...
const PROOF_COPY = {
  'en-CA': {
    title: 'Organizational Proof | UnionEyes',
    description:
      'Organizational proof architecture for deployment walkthroughs, pilot simulation artifacts, executive scenario modeling, and governance evidence.',
    badge: 'Organizational Proof',
    heroHeading: 'Organizational proof systems for real deployment review.',
    heroDescription:
      'UnionEyes surfaces evidence architecture, walkthroughs, simulations, and executive-grade proof packs so organizational modernization can be reviewed as a real governance change, not a promise.',
    ...
    briefingLabel: 'Executive Continuity Briefing System',
    briefingTitle: 'Executive-grade continuity briefings',
    walkthroughLabel: 'Governance Operational Walkthroughs',
    walkthroughTitle: 'How governance modernization operates in practice',
    beforeAfterLabel: 'Organizational Before/After Map',
    beforeAfterTitle: 'Organizational evolution over time',
    ...
    continuityOverviewDesc:
      'Summarizes continuity posture, governance coherence, operational stability, and organizational memory health.',
    ...
    evidenceLabel: 'Organizational Evidence Architecture',
    evidenceTitle: 'Organizational proof density for executive and procurement review',
    evidenceDesc:
    ...
    deploymentLabel: 'Organizational Deployment Walkthrough',
    ...
    pilotTitle: 'Realistic organizational pilot examples',
    ...
    operationalSimulationLabel: 'Organizational Continuity Simulation Artifacts',
    ...
    fragmentationOperationalLabel: 'Organizational fragmentation visibility',
    memoryIndicatorLabel: 'Organizational memory indicator',
    ...
    scenarioTitle: 'How organizational infrastructure operates inside an organization',
    stepWord: 'Step',
    ...
    rolloutSimulationTitle: 'Organizational rollout simulation flow',
    briefingFlowsLabel: 'Executive Continuity Briefing Flows',
    briefingFlowsTitle: 'Briefings that read like operational guidance',
    riskNarrativesTitle: 'Continuity risk narratives',
    riskNarrativeOne:
      'Operational continuity appears dependent on concentrated organizational knowledge within a limited number of coordination pathways.',
    riskNarrativeTwo:
      'Governance coherence increases when review rationale and checkpoint ownership are explicit throughout rollout.',
    riskNarrativeThree:
    ...
    sectionEventWalkthroughs: 'Organizational continuity event walkthroughs',
    ...
    sectionMemoryStress: 'Organizational memory stress models',
  ...
  'fr-CA': {
    ...
    tabOverview: 'Apercu',
    tabSimulation: 'Simulations',
    tabScenario: 'Intelligence de scenarios',
    ...
    walkthroughLabel: 'Parcours organisationnels de gouvernance',
    walkthroughTitle: 'Comment la modernisation de la gouvernance fonctionne en pratique',
    beforeAfterLabel: 'Carte organisationnelle avant/apres',
    beforeAfterTitle: 'Evolution organisationnelle dans le temps',
    ...
    continuityOverviewDesc:
      'Resume la posture de continuite, la coherence de gouvernance, la stabilite operationnelle et la sante de la memoire organisationnelle.',
    fragmentationVisibilityTitle: 'Visibilite de la fragmentation',
    fragmentationVisibilityDesc:
      'Rend visibles les silos, les vulnerabilites de transition, les ecarts de coordination et la fragilite de l integration.',
    governanceAlignmentTitle: 'Alignement de gouvernance',
    governanceAlignmentDesc:
      'Documente l explicabilite, la preparation de supervision, la continuite de gouvernance et les parcours de revision.',
    ...
    evidenceLabel: 'Architecture de preuve organisationnelle',
    evidenceTitle: 'Densite de preuve organisationnelle pour les revues executives et achats',
    evidenceDesc:
    ...
    deploymentLabel: 'Parcours organisationnel de deploiement',
    ...
    pilotTitle: 'Exemples organisationnels de pilote realistes',
    ...
    operationalSimulationLabel: 'Artefacts de simulation organisationnelle de continuite',
    ...
    fragmentationOperationalLabel: 'Visibilite de la fragmentation organisationnelle',
    memoryIndicatorLabel: 'Indicateur de memoire organisationnelle',
    ...
    timelineLabel: 'Systemes de calendrier de deploiement',
    timelineTitle: 'Un rythme phase pour la confiance executive et achats',
    rolloutSimulationTitle: 'Flux de simulation de deploiement organisationnel',
    briefingFlowsLabel: 'Flux de briefing de continuite executive',
    ...
    riskNarrativeOne:
      'La continuite operationnelle semble dependre d une connaissance organisationnelle concentree dans un nombre limite de parcours de coordination.',
    riskNarrativeTwo:
      'La coherence de gouvernance progresse lorsque le raisonnement de revue et la responsabilite des points de controle sont explicites.',
    riskNarrativeThree:
    ...
    sectionEventWalkthroughs: 'Parcours d evenements de continuite organisationnelle',
    ...
    sectionMemoryStress: 'Modeles de stress de memoire organisationnelle',
...
const DATA_TRANSLATIONS = {
  ...
  it: {
    ...
    'Organizational Resilience': 'Resilienza istituzionale',
  ...
  pt: {
    ...
    'Organizational Resilience': 'Resiliencia institucional',
