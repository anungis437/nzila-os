...
const PAGE_COPY = {
  'en-CA': {
    ...
    outcomes: [
      { icon: Briefcase, title: 'Clear scope', desc: 'Defined modules, staged rollout options, and simple implementation paths.' },
      { icon: FileCheck, title: 'Review-ready documentation', desc: 'Explainability, controls, and security details are ready for due diligence.' },
      { icon: CheckCircle2, title: 'Lower implementation risk', desc: 'Phased deployment avoids big-bang risk and fits organizational change capacity.' },
      { icon: BarChart3, title: 'Visible value for leadership', desc: 'Outcomes are measured in cycle time, admin load, and continuity health.' },
      { icon: Layers, title: 'Shared alignment', desc: 'Operations, governance, policy, and technology teams follow one plan.' },
    ],
    confidenceHeading: 'Build confidence through safe, phased deployment',
    confidenceBody:
    ...
    confidenceCards: [
      { title: 'Implementation boundaries', body: 'Clear scope for pilot modules, ownership, and continuity needs.' },
      { title: 'Review paths', body: 'Documented oversight, explainability, and audit-ready decision paths.' },
      { title: 'Phased adoption', body: 'Sequenced checkpoints that match rollout speed to change capacity.' },
    ],
    rolloutHeading: 'Rollout sequence for planning',
    rolloutBody:
    ...
    governanceMaturityDimensions,
    pacingHeading: 'Phased pacing for confidence',
    pacingBody:
  ...
  'fr-CA': {
    ...
    description:
      'UnionEyes donne aux équipes d approvisionnement une voie de déploiement claire : portée définie, contrôles simples, opérations conscientes des fédérations et preuves à revoir.',
    ...
    outcomes: [
      { icon: Briefcase, title: 'Portée claire', desc: 'Modules définis, options par étapes et parcours simples pour la mise en œuvre.' },
      { icon: FileCheck, title: 'Documentation prête à revoir', desc: 'Explicabilité, contrôles et détails de sécurité sont prêts pour la diligence raisonnable.' },
      { icon: CheckCircle2, title: 'Risque réduit', desc: 'Le déploiement par phases évite le risque de bascule massive et respecte la capacité de changement.' },
      { icon: BarChart3, title: 'Valeur visible pour le leadership', desc: 'Les résultats sont mesurés en délais, charge administrative et continuité.' },
      { icon: Layers, title: 'Alignement partagé', desc: 'Opérations, gouvernance, politique et technologie suivent un même plan.' },
    ],
    confidenceHeading: 'Bâtir la confiance avec un déploiement sûr',
    confidenceBody:
      'Les équipes d approvisionnement peuvent évaluer la sécurité du déploiement avec des limites claires, des garde-fous de continuité, un rythme adapté et des opérations conscientes des fédérations.',
    confidenceCards: [
      { title: 'Limites de mise en œuvre', body: 'Portée claire des modules pilotes, de la gouvernance et des besoins de continuité.' },
      { title: 'Voies de revue', body: 'Surveillance documentée, explicabilité et voies de décision prêtes pour l audit.' },
      { title: 'Adoption par phases', body: 'Points de contrôle séquencés qui adaptent la vitesse de déploiement à la capacité de changement.' },
    ],
    rolloutHeading: 'Séquence de déploiement pour la planification',
    rolloutBody:
      'Ce parcours aide les équipes d approvisionnement et de direction à valider la déployabilité, le risque et le réalisme avant l engagement.',
    phaseLabel: 'Phase',
    rolloutPathway: [
      'Évaluation',
      'Revue de continuité',
    ...
    operationalMaturityPathway: ['Réactif', 'Coordonné', 'Explicable', 'Conscient de la continuité', 'Résilient organisationnellement'],
    ...
    pacingHeading: 'Rythme par phases pour la confiance',
    pacingBody:
      'Les évaluateurs peuvent voir comment le déploiement est séquencé, où la gouvernance reste engagée et comment la continuité est protégée.',
    deploymentTimelines: [
    ...
    dueDiligenceHeading: 'La diligence raisonnable comme preuve',
    dueDiligenceBody:
      'Les équipes d approvisionnement reçoivent des preuves organisées pour la revue, la confiance et les décisions de déploiement sûres pour la gouvernance.',
    procurementEvidenceBinder: [
    ...
    governanceOperationalWalkthroughs: [
      { type: 'Transition de leadership', focus: 'Préservation de la continuité', narrative: 'Maintient la mémoire et la continuité de gouvernance pendant le roulement.' },
      { type: 'Revue de gouvernance', focus: 'Explicabilité', narrative: 'Montre comment les décisions restent traçables avec des points de revue clairs.' },
      { type: 'Coordination de comités', focus: 'Cohérence opérationnelle', narrative: 'Aligne les rôles et les transferts pour garder des décisions coordonnées.' },
      ...
      { type: 'Réduction de fragmentation', focus: 'Alignement', narrative: 'Réduit les silos avec un langage de gouvernance partagé et un rythme de revue.' },
      { type: 'Revue d’approvisionnement', focus: 'Confiance de gouvernance', narrative: 'Soutient la diligence raisonnable avec garde-fous, limites et preuves.' },
    ],
    simulationHeading: 'Couches de revue de gouvernance',
    governanceReviewSimulationLayers: [
      'Points de revue',
