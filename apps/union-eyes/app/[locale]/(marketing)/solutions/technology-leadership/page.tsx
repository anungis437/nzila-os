...
const PAGE_COPY = {
  'en-CA': {
    ...
    outcomesHeading: 'What technology leaders gain with UnionEyes',
    outcomes: [
  ...
  'fr-CA': {
    ...
    principles: [
      ...
      { label: 'Aucune surveillance des travailleuses et travailleurs', sub: 'Imposée au niveau architectural' },
      { label: 'Surveillance humaine requise', sub: 'Imposée structurellement' },
