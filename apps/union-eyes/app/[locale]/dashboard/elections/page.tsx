      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">{t("activeElections")}</p>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">{t("totalEligibleVoters")}</p>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">{t("upcomingElections")}</p>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>{t("tableHeaderPeriod")}</TableHead>
              <TableHead>{t("tableHeaderTurnout")}</TableHead>
              <TableHead>{t("tableHeaderPositions")}</TableHead>
