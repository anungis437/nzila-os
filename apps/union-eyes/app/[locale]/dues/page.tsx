...
export default function DuesDashboardPage() {
  ...
  const t = useTranslations('dues.dashboard');
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">{t('reconciliationQueue')}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-6 cursor-pointer hover:bg-muted/50"
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-semibold">{t('reconcileRemittances')}</h3>
      ...
      <Card>
        <div className="p-6 border-b">
          <h2 className="text-xl font-semibold">{t('recentRemittances')}</h2>
        </div>
        <Table>
          <TableHeader>
            <TableRow>
