...
export default function MobileDashboardPage() {
  ...
  const quickActions = [
    {
      ...
      description: t("newClaimDescription"),
      href: '/claims/new',
      icon: (
    ...
    {
      title: t("findMemberTitle"),
      description: t("findMemberDescription"),
      href: '/members',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Quick Actions */}
      <div className="p-4">
        <h2 className="text-lg font-semibold text-gray-900 mb-3">{t("quickActionsTitle")}</h2>
        <div className="grid grid-cols-2 gap-3">
      ...
      {/* Recent Activity */}
      <div className="p-4">
        <h2 className="text-lg font-semibold text-gray-900 mb-3">{t("recentActivityTitle")}</h2>
        <div className="bg-white rounded-lg shadow-sm divide-y divide-gray-100">
          <ActivityItem
            title={t("activityUpdate")}
            description={t("activityStatusChange")}
            time={t("activity2HoursAgo")}
          />
          <ActivityItem
            title={t("activityNewMember")}
            description={t("activityMemberJoined")}
            time={t("activity5HoursAgo")}
          />
          <ActivityItem
            title={t("activityDocumentUploaded")}
            description={t("activityDocumentName")}
            time={t("activityYesterday")}
          />
        </div>
      </div>
      ...
      <div className="p-4 pb-24">
        <div className="bg-white rounded-lg p-4 shadow-sm">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-medium text-gray-900">{t("syncStatusTitle")}</h3>
              <p className="text-sm text-gray-500">
                {isOnline ? t("syncConnected") : t("syncOfflineMode")}
              </p>
            </div>
