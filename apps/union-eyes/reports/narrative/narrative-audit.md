...
Generated: 2026-05-13T02:25:00.445Z

## Summary

- Files scanned: **8**
- Hard-fail violations: **0**
- Warning violations: **161**
- Rule failures: **2**
- Average Institutional Maturity: **66/100**
...
- L132 [warning/warning] `platform` — Built-in platform guarantees
...
- L7166 [warning/warning] `platform` — "heroDescription": "Grievances. Finances. Membership. Compliance. One governed platform — total transparency, total accountability, zero guesswork.",
- L7168 [warning/warning] `platform` — "ctaSecondary": "View Platform Overview",
- L7179 [warning/warning] `platform` — "solutionHeading": "A Platform Built for How Unions Actually Operate",
- L7199 [warning/warning] `platform` — "governanceDescription": "Union executives, finance officers, and legal teams need a platform they can defend — to their members, their boards, and their auditors.",
- L7208 [warning/warning] `platform` — "modulesBadge": "Platform Modules",
- L7230 [warning/warning] `platform` — "missionDescription": "UnionEyes was born when a healthcare representative lost a winnable grievance because her notes were trapped in a spreadsheet. The employer had a million-dollar HR system. She h
- L7404 [warning/warning] `centralized` — "noGovernanceOversight": "No centralized governance oversight"
- L7426 [warning/warning] `platform` — "heroDescription": "Real-time operational status of UnionEyes platform services",
- L7428 [warning/warning] `platform` — "pageDescription": "Real-time status of UnionEyes platform services."
- L7432 [warning/warning] `platform` — "platform": "Capabilities",
- L7484 [warning/warning] `platform` — "badge": "Platform Module",
- L7518 [warning/warning] `platform` — "badge": "Platform Module",
- L7553 [warning/warning] `platform` — "badge": "Platform Module",
- L7583 [warning/warning] `platform` — "badge": "Platform Module",
- L7593 [warning/warning] `platform` — "feat4Desc": "Match platform billing against bank statements and internal ledgers. Flag discrepancies before they become audit findings.",
- L7643 [warning/warning] `platform` — "collectDesc": "UnionEyes collects information necessary to provide union management services, including: name, email address, union membership details, and usage data. We collect this information whe
- L7657 [warning/warning] `platform` — "pageDescription": "Terms and conditions governing the use of UnionEyes union management platform.",
- L7660 [warning/warning] `platform` — "acceptanceDesc": "By accessing or using UnionEyes, you agree to be bound by these Terms of Service. UnionEyes is a platform designed for union organizations in Canada and is governed by Canadian law.
- L7662 [warning/warning] `platform` — "useDesc": "You may use UnionEyes solely for lawful union management purposes, including grievance tracking, member communication, voting, and organizational administration. You agree not to misuse th
- L7666 [warning/warning] `platform` — "liabilityDesc": "UnionEyes is provided \"as is\" without warranties of any kind. We are not liable for any indirect, incidental, or consequential damages arising from your use of the platform. Our to
- L7678 [warning/warning] `platform` — "standardsDesc": "We aim to conform to the Web Content Accessibility Guidelines (WCAG) 2.1 Level AA and comply with the Accessible Canada Act (ACA). Our platform is regularly audited for accessibility
- L7721 [warning/warning] `platform` — "ctaDescription": "Every engagement starts with a controlled pilot. We work with your team to define scope, select modules, and validate the platform against your real workflows.",
- L7723 [warning/warning] `platform` — "ctaSecondary": "View Platform Overview",
- L7733 [warning/warning] `platform` — "auditDesc": "Every action on the platform is logged with who, what, when, and why. Audit logs are immutable, exportable, and available to authorized roles at any time.",
- L7739 [warning/warning] `platform` — "reconDesc": "Platform billing reconciles against your internal ledgers. Allocation is transparent. Every dollar is accounted for from parent invoice to local cost centre.",
- L7743 [warning/warning] `platform` — "defensibilityDesc": "Evidence sealing, grievance chain of custody, and tamper-evident records. When your decisions are challenged, the platform provides the proof.",
- L7749 [warning/warning] `disruption` — "disruptionTitle": "Operational disruption modeling",
- L7887 [warning/warning] `centralized` — "ba3After": "Centralized campaign tracking with real-time progress",
- L8633 [warning/warning] `AI-powered` — "benefit2": "AI-powered grievance triage & drafting",
- L8785 [warning/warning] `platform` — "platform": {
- L8789 [warning/warning] `platform` — "operationsOverview": "Nzila Platform Operations — here's your overview.",
- L8805 [warning/warning] `platform` — "platformHealthIncidents": "Platform health & incidents",
- L8810 [warning/warning] `platform` — "platformAnalytics": "Platform Analytics",
- L8817 [warning/warning] `platform` — "platformSecurityPosture": "Platform security posture",
- L8820 [warning/warning] `platform` — "platformHealth": "Platform Health",
- L8827 [warning/warning] `platform` — "recentPlatformEvents": "Recent Platform Events",
- L8834 [warning/warning] `platform` — "platformActivityAppears": "Platform activity will appear here",
- L9135 [warning/warning] `platform` — "title": "Platform Operations",
- L9136 [warning/warning] `platform` — "subtitle": "Real-time platform health, incidents, and operational metrics",
- L9148 [warning/warning] `platform` — "platformUptimeTitle": "Platform Uptime",
- L9209 [warning/warning] `platform` — "platformAdoptionTitle": "Platform Adoption",
- L9210 [warning/warning] `platform` — "moduleUsageDescription": "Module usage across the platform",
- L9246 [warning/warning] `platform` — "featureAdoptionDescription": "Usage across the platform by feature",
- L10566 [warning/warning] `AI-powered` — "description": "AI-powered recommendations"
...
- L7432 [warning/warning] `platform` — "platform": "Capacités",
- L8785 [warning/warning] `platform` — "platform": {
