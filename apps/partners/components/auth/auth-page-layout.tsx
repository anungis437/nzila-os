      ...
      <div className="relative hidden w-[55%] overflow-hidden lg:block">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between p-12 xl:p-16">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs font-semibold">
            <span className="rounded-full bg-emerald/18 px-3 py-1.5 text-emerald">Secure Access</span>
            <span className="rounded-full bg-gold/18 px-3 py-1.5 text-gold">Revenue Transparency</span>
            <span className="rounded-full bg-white/12 px-3 py-1.5 text-gray-200">Partner Governance</span>
          </div>
        </div>
      </div>

      <div className="flex min-h-screen flex-1 flex-col bg-gray-50">
        <div className="border-b border-navy/10 bg-navy px-6 py-5 text-white lg:hidden">
          <p className="text-[11px] font-semibold tracking-widest text-electric-light uppercase">Nzila Partner Network</p>
        ...
        <div className="flex flex-1 items-center justify-center px-6 py-10 sm:px-10">
          ...
          <div className="mb-6 space-y-2">
            ...
            <p className="text-sm text-gray-500">Access partner deals, payouts, and shared workspaces.</p>
          </div>
