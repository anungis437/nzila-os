 ...
 *
 * Used on detail pages to visualise lifecycle phases (order progress,
 * quote lifecycle, etc.).  Each step shows an icon or number,
 * a label, and a connecting bar between steps.
 */
