...
const logger = createLogger('console.auth')
...
export async function GET(request: NextRequest) {
  ...
  return withSpan('api.console.auth.nextauth.get', { 'http.method': 'GET' }, async () => {
...
export async function POST(request: NextRequest) {
  ...
  return withSpan('api.console.auth.nextauth.post', { 'http.method': 'POST' }, async () => {
    try {
