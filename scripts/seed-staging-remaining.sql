...
-- ai_knowledge_sources (standalone, entity_id = org)
INSERT INTO ai_knowledge_sources (id, entity_id, app_key, source_type, title, created_by)
VALUES
...
-- ai_capability_profiles (entity_id = org)
INSERT INTO ai_capability_profiles (id, entity_id, app_key, environment, profile_key, created_by)
VALUES
...
-- ai_actions (entity_id = org)
INSERT INTO ai_actions (id, entity_id, app_key, profile_key, action_type, proposal_json, requested_by)
VALUES
...
INSERT INTO ai_embeddings (id, entity_id, app_key, source_id, chunk_id, chunk_text)
VALUES
...
INSERT INTO ai_deployment_routes (id, deployment_id, entity_id, app_key, profile_key, feature)
VALUES
...
INSERT INTO ai_action_runs (id, action_id, entity_id, status)
VALUES
...
INSERT INTO ai_knowledge_ingestion_runs (id, entity_id, source_id, status)
VALUES
...
-- ai_requests (entity_id = org)
INSERT INTO ai_requests (id, entity_id, app_key, profile_key, feature, provider, model_or_deployment, request_hash, response_hash, status, tokens_in, tokens_out, cost_usd, latency_ms)
VALUES
...
-- ai_usage_budgets (entity_id = org)
INSERT INTO ai_usage_budgets (id, entity_id, app_key, profile_key, month, budget_usd)
VALUES
...
-- ml_datasets (entity_id = org)
INSERT INTO ml_datasets (id, entity_id, dataset_key, period_start, period_end, row_count, sha256)
VALUES
...
-- ml_models (entity_id = org)
INSERT INTO ml_models (id, entity_id, model_key, algorithm, version, status)
VALUES
...
-- ml_training_runs (entity_id = org)
INSERT INTO ml_training_runs (id, entity_id, model_key, dataset_id, status, finished_at)
VALUES
...
INSERT INTO ml_inference_runs (id, entity_id, model_id, status, input_period_start, input_period_end, finished_at)
VALUES
...
-- ml_scores_stripe_daily (→ ml_models, entity_id)
INSERT INTO ml_scores_stripe_daily (id, entity_id, date, score, threshold, model_id, inference_run_id)
VALUES
...
-- ml_scores_stripe_txn (→ ml_models, entity_id)
INSERT INTO ml_scores_stripe_txn (id, entity_id, occurred_at, amount, score, threshold, model_id)
VALUES
...
INSERT INTO ml_scores_ue_cases_priority (id, entity_id, case_id, occurred_at, score, predicted_priority, model_id)
VALUES
...
INSERT INTO ml_scores_ue_sla_risk (id, entity_id, case_id, occurred_at, probability, model_id)
VALUES
...
-- stripe_connections (entity_id = org)
INSERT INTO stripe_connections (id, entity_id, account_id, connected_by)
VALUES
...
-- stripe_webhook_events (entity_id = org)
INSERT INTO stripe_webhook_events (id, entity_id, stripe_event_id, type, livemode, created, payload_json, signature_valid)
VALUES
...
-- stripe_subscriptions (entity_id = org)
INSERT INTO stripe_subscriptions (id, entity_id, stripe_customer_id, stripe_subscription_id, stripe_price_id, plan_name, amount_cents, status, created_by)
VALUES
...
INSERT INTO stripe_payments (id, entity_id, stripe_object_id, object_type, status, amount_cents, occurred_at, raw_event_id)
VALUES
...
-- stripe_payouts (entity_id = org)
INSERT INTO stripe_payouts (id, entity_id, payout_id, amount_cents, status, arrival_date, occurred_at)
VALUES
...
-- stripe_reports (entity_id = org)
INSERT INTO stripe_reports (id, entity_id, report_type, start_date, end_date, sha256)
VALUES
...
INSERT INTO stripe_disputes (id, entity_id, dispute_id, payment_id, amount_cents, status, reason, occurred_at)
VALUES
...
INSERT INTO stripe_refunds (id, entity_id, refund_id, payment_id, amount_cents, requested_by, occurred_at)
VALUES
