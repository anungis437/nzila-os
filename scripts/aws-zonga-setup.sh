...
echo ""
echo "# CloudFront (manual step — see docs/categories/products-and-market/zonga/AWS_ZONGA_SETUP.md Part 4)"
...
echo ""
echo "📖 For detailed setup steps, see: docs/categories/products-and-market/zonga/AWS_ZONGA_SETUP.md"
