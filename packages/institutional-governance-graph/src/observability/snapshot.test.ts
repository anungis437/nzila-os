...
describe('Phase 4 — observability snapshot shape (counts only)', () => {
  it('emits an empty-but-structured snapshot for an empty graph', () => {
    ...
    expect(out!.topology.normalizedRelationships).toBe(0)
    expect(out!.topology.lineageChains).toBe(0)
    expect(out!.topology.continuityProjections).toBe(0)
    expect(out!.topology.protectedRedactions).toBe(0)
  ...
  it('counts substrate / timeline / evidence / continuity / provenance', () => {
    ...
    expect(out!.topology.normalizedRelationships).toBeGreaterThan(0)
    expect(out!.topology.lineageChains).toBeGreaterThan(0)
    expect(out!.topology.continuityProjections).toBeGreaterThan(0)
