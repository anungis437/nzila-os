...
export const DATA_VERSIONS: DataModuleVersion[] = [
  {
    ...
    source: 'CRA corporation tax rates, provincial/territorial corporation tax updates, ITA s.123/125',
  ...
  },
  {
    ...
    taxYear: 2026,
    lastVerified: '2026-08-25',
    source: 'CRA current-year tax rates and income brackets (2026), CRA T4032/TD1, Revenu Quebec',
