# @nzila/continuity-observability
...
- All observation is at the SYSTEM scope (surface, route, product). Person-scope observation is structurally rejected.
- Continuity posture and trajectory are interpretive bandings, not numeric scores presented as truth.
- Cognitive safety thresholds are stabilization budgets, not behavioral targets.
