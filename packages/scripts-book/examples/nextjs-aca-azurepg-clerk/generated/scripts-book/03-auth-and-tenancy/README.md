...
multi-org isolation model used by **CourtLens**.
...
| `AUTH_PROVIDER_URL`  | clerk issuer / org URL    |
...
Org isolation is enforced at the data layer using the **orgId**
...
2. Create an clerk organization or group for the org.
