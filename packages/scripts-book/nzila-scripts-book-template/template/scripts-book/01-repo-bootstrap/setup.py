#!/usr/bin/env python3
"""Bootstrap {{REPO_NAME}} for local development (cross-platform)."""
...
def main() -> None:
    ...
    print(
        "==> Bootstrap complete. Run 'pnpm --filter {{PRIMARY_APP_PATH}} run dev' to start."
    )
