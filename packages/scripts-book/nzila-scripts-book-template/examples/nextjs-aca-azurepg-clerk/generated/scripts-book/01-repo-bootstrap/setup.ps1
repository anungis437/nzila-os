...
# -----------------------------------------------------------------------------
# setup.ps1 — Bootstrap courtlens-platform for local development (Windows)
# -----------------------------------------------------------------------------

$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Definition
$RepoRoot  = Resolve-Path (Join-Path $ScriptDir "../..")

Write-Host "==> Bootstrapping courtlens-platform ..."
...
Write-Host "==> Bootstrap complete. Run 'pnpm --filter apps/web run dev' to start."
