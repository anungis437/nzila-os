...
# Contributing to CourtLens

Thank you for your interest in contributing to CourtLens! This guide
covers everything you need to get started.

## Getting Started

1. Fork the courtlens-platform repository.
2. Clone your fork locally:

   ```bash
   git clone https://github.com/<your-username>/courtlens-platform.git
