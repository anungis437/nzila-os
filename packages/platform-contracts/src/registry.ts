...
const APP_REGISTRY_RAW: AppManifestInput[] = [
...

  {
    ...
    basePath: '/abr',
    tier: 'PILOT',
    lifecycleNote: 'PILOT — Deployed to staging as nzila-os-abr (FairCase); production blocked pending DNS + promotion criteria (see governance/release/deployment-inventory.json).',
    appType: 'web-app',
