...
CREATE TYPE "public"."document_category" AS ENUM('minute_book', 'filing', 'resolution', 'minutes', 'certificate', 'year_end', 'export', 'attestation', 'ingestion_report', 'other');--> statement-breakpoint
...
ALTER TABLE "governance_actions" ADD CONSTRAINT "governance_actions_entity_id_entities_id_fk" FOREIGN KEY ("entity_id") REFERENCES "public"."entities"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
