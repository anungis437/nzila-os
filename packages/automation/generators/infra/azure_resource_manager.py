...
class AzureResourceManager:
    ...
    def _check_azure_cli(self):
        ...
        try:
            ...
            if result.returncode != 0:
                print(
                    "Warning: Azure CLI not found. Install from: https://aka.ms/install-az-cli"
                )
                return False
            return True
    ...
    def generate_resource_names(
        self, platform_id: str, environment: str = "prod"
    ) -> Dict[str, str]:
    ...
    def generate_bicep_template(
        self, platform_id: str, manifest: Dict[str, Any], environment: str = "prod"
    ) -> str:
...
"""
    ...
    def generate_github_workflow(
        self, platform_id: str, manifest: Dict[str, Any]
    ) -> str:
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("\nCommands:")
        print(
            "  generate-infra <manifests.json> <output-dir>  - Generate infrastructure code"
        )
        print(
            "  provision-shared [--dry-run]                  - Provision shared resources"
        )
        sys.exit(1)
