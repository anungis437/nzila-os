...
export const DEFAULT_PROVIDER_ROUTES: readonly ProviderRoute[] = [
  ...
  },
  {
    provider: 'mtn_momo',
    method: PaymentMethod.MOBILE_MONEY,
    supportedCurrencies: ['UGX', 'GHS', 'XOF', 'XAF', 'RWF'],
    supportedCountries: ['UG', 'GH', 'CI', 'CM', 'RW', 'BJ', 'SN'],
    minAmount: 1,
    maxAmount: 500000,
  },
  {
  ...
  },
  {
    ...
    supportedCurrencies: ['NGN', 'GHS', 'KES', 'ZAR', 'TZS', 'UGX', 'USD', 'GBP', 'EUR'],
    supportedCountries: ['NG', 'GH', 'KE', 'ZA', 'TZ', 'UG', 'US', 'GB'],
    minAmount: 1,
    maxAmount: 1000000,
  },
  {
  ...
  },
  {
    ...
    supportedCurrencies: ['USD', 'EUR', 'GBP', 'ZAR', 'NGN', 'KES'],
    supportedCountries: ['US', 'GB', 'EU', 'ZA', 'NG', 'KE'],
    minAmount: 0.5,
    maxAmount: 999999,
  },
] as const
