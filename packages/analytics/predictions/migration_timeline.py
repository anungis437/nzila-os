...
class MigrationTimeline:
    ...
    def _load_platforms(self) -> List[Dict[str, Any]]:
        ...
        return [
            ...
            },
            {
                ...
                "complexity": "HIGH",
                "entities": 37,
                "dependencies": ["Base44", "QuickBooks", "Xero"],
            ...
            },
            {
                ...
                "entities": 80,
                "dependencies": ["Base44"],
                "risk_factors": ["Base44 migration"],
                "priority": 8
            }
        ]
    
    def estimate_timeline(self, platform_id: str, parallel_teams: int = 1) -> Dict[str, Any]:
        ...
        factors = self.COMPLEXITY_FACTORS.get(complexity, {"base_weeks": 8, "risk_multiplier": 1.0})
    ...
    def generate_roadmap(self, parallel_teams: int = 3) -> Dict[str, Any]:
        ...
        phases = [
            ...
            {"name": "EdTech/Legal", "weeks": 24, "platforms": ["abr_insights", "court_lens"]},
            {"name": "Fintech", "weeks": 28, "platforms": ["c3uo", "stsa", "insight_cfo"]},
            {"name": "Commerce/Insur", "weeks": 30, "platforms": ["sentryiq", "shop_quoter", "trade_os"]},
            {"name": "Entertainment", "weeks": 22, "platforms": ["congowave", "cyberlearn"]},
        ...
        return {
            ...
            "estimated_completion": (datetime.now() + timedelta(weeks=parallelized_weeks)).strftime("%Y-%m"),
            "cost_estimate": {
                "per_team_week": 15000,
