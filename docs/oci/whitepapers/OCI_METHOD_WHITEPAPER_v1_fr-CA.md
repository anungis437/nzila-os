# Livre blanc méthodologique OCI v1 — Autorité canonique

**Bandeau:** L’écart de continuité | Autorité méthodologique canonique  
**Série:** Nzila Ventures / Initiative de recherche Nzila OS  
**Classe de document:** Autorité méthodologique canonique  
**Statut:** Source contraignante de vérité pour la doctrine OCI / OCRA  
**S’applique à:** artefacts exécutifs, documents compagnons, matériel d’approvisionnement, guides d’implantation et descriptions contractuelles  
**Version:** v1.2
...
Ce document ne remplace pas la doctrine canonique en cinq phases publiée dans [docs/oci/OCI_METHOD.md](../OCI_METHOD.md). Il l’ancre, la protège et en fixe les limites d’interprétation publique.
...
| Dette de continuité | Dépendance opérationnelle accumulée envers l’interprétation non documentée, les relations informelles et la mémoire individuelle. |
| Charge de reconstruction | Effort requis pour rebâtir la continuité à partir de fragments après une transition. |
| Concentration de stewardship | Situation dans laquelle un petit nombre de personnes porte une charge disproportionnée de continuité organisationnelle. |
| Survivabilité de l’accueil | Capacité structurelle des successeurs à devenir efficaces sans médiation constante des vétérans. |
| Fragmentation de modernisation | Motif par lequel la modernisation améliore la surface opérationnelle tout en érodant le contexte interprétatif. |
| Confiance opérationnelle | Confiance que les parties prenantes accordent à la capacité d’une organisation à préserver sa continuité, maintenir son intégrité de gouvernance, valider la lignée de ses preuves et démontrer une décision responsable dans le temps. |
...
- [docs/oci/whitepapers/OCI_METHOD_COMPANION_WHITEPAPER.md](OCI_METHOD_COMPANION_WHITEPAPER.md)
- [docs/oci/whitepapers/THE_CONTINUITY_GAP_OPERATIONAL_REALITY_EDITION.md](THE_CONTINUITY_GAP_OPERATIONAL_REALITY_EDITION.md)
- [docs/oci/whitepapers/OCI_OCRA_WHITEPAPER_ARCHITECTURE_v2.md](OCI_OCRA_WHITEPAPER_ARCHITECTURE_v2.md)
