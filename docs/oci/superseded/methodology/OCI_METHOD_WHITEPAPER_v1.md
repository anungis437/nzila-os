...
- **Senior-validator protocol & internal pre-mortem** — [RICHARD_SHARPE_VALIDATION_PROTOCOL.md](../government-readiness/RICHARD_SHARPE_VALIDATION_PROTOCOL.md) and [INTERNAL_PRE_MORTEM_HYPOTHETICAL_REVIEWER_CHALLENGES.md](../government-readiness/INTERNAL_PRE_MORTEM_HYPOTHETICAL_REVIEWER_CHALLENGES.md): the adversarial public-sector review protocol and Nzila's own internal red-team pre-mortem against it (external validation is a separate, not-yet-completed track).
