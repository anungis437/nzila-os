...
doctrine is [`docs/oci/OCI_AI_BOUNDARY.md`](../../OCI_AI_BOUNDARY.md); this document restates it
for the assessment implementation and is kept for engineers, not procurement readers. See
