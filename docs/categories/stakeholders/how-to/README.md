...
Task-oriented guides for specific goals. Each guide assumes you have a working development
environment.

Only the guides listed below exist. Entries that were previously listed here as links to
unwritten pages have been removed; the authoritative substitute is named where one exists.

## Available guides

- [Golden Path Developer Guide](GOLDEN_PATH_DEVELOPER_GUIDE.md) — end-to-end developer path
