...
| nacp-exams | EXPERIMENTAL | education | education | DRC-native national education & examination infrastructure (national → province → subdivision → pool → centre → school → candidate); integrity/anti-corruption are capabilities within the education product. Health endpoint live. Early-stage vertical. |
