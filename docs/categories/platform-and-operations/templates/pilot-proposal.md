...
A **{{PILOT_DURATION}}-day time-limited pilot** of UnionEyes with {{ORG_NAME}}
...
| **Week 7–{{PILOT_DURATION_WEEKS}}** | Pilot review vs. readiness checklist; go/no-go for expansion |
...
| Contracts complete | {{CONTRACTS_STATUS}} |
...
3. Readiness checklist reviewed at day 30 and day {{PILOT_DURATION}}
