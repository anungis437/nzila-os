...
3. [Incident response summary](./03-incident-response-summary.md) *(see vendor-risk-pack)*
...
7. [Responsible AI controls](./07-responsible-ai-controls.md)
8. [Subprocessors](./08-subprocessors.md)
...
3. `03-incident-response-summary.md`
4. `04-access-control-model.md`
5. `05-backup-restore-policy.md`
6. `06-vulnerability-management.md`
7. `07-responsible-ai-controls.md`
8. `08-subprocessors.md`
9. `09-contact-and-sla.md`
10. `10-faq.md`
...
- `docs/commercial/vendor-risk-pack/*`
