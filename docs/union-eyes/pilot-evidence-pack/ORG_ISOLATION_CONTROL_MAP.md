...
_Reviewer: Any CISO/security auditor should start with Controls 1–3 as the primary isolation backbone,
then review Controls 5–6 as the documented exception surface._
