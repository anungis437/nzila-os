...
- Operational build scan: [`20_OPERATIONAL_BUILD_DEMO_SCAN.md`](20_OPERATIONAL_BUILD_DEMO_SCAN.md), [`tooling/reality/operational-build-scan.ts`](../../../tooling/reality/operational-build-scan.ts), [`tooling/reality/operational-build-demo-allowlist.json`](../../../tooling/reality/operational-build-demo-allowlist.json).
