...
- [CONTROL_PLANE_PRINCIPLES.md](governance/CONTROL_PLANE_PRINCIPLES.md)
- [PLATFORM_VS_APP_DECISION_RULE.md](architecture/PLATFORM_VS_APP_DECISION_RULE.md)
- [APP_DOMAIN_CORE_STANDARD.md](APP_DOMAIN_CORE_STANDARD.md)
