...
> `tooling/scripts/validate-operational-proving.mjs` resolves this directory by path; moving it would break a gate rather than improve clarity. Current authority lives in
