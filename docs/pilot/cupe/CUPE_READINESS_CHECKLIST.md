...
- [x] PR-033: RBAC matrix + action-denial tests
  - [x] `docs/pilot/cupe/CUPE_RBAC_MATRIX.md` complete
...
- [x] PR-042: Malware scanning boundary + ClamAV
  ...
  - [x] Control boundary documented in `docs/pilot/cupe/CUPE_MALWARE_CONTROL_BOUNDARY.md`
...
- [x] PR-061: Setup checklist + onboarding UX
  - [x] `docs/pilot/cupe/CUPE_PILOTING_QUICK_START.md` created (1–2 page guide)
  - [x] First-run checklist logic (10 steps, 4 categories, `computeSetupProgress`, `getNextStep`)
- [x] PR-062: Pilot documentation pack
  - [x] `docs/pilot/cupe/CUPE_PILOT_ADMIN_RUNBOOK.md` — daily/weekly checks, troubleshooting
  - [x] `docs/pilot/cupe/CUPE_PILOT_USER_GUIDE.md` — user quick-start
  - [x] `docs/pilot/cupe/CUPE_PILOT_SUPPORT_SOP.md` — platform support playbook
  - [x] `docs/pilot/cupe/CUPE_PILOT_ROLLBACK_RUNBOOK.md` — pause/recovery
...
- [x] PR-072: Final checklist + go/no-go review
  ...
  - [x] `docs/pilot/cupe/CUPE_PILOT_GO_NO_GO_REVIEW.md` completed
