...
**Overall**: ✅ PASS
**Commit**: `d032b011`
**Timestamp**: 2026-04-11T05:31:13.471Z
**Duration**: 4051ms
**CI**: No
...
|--------|------|---------|----------|
| ✅ | Org boundary: No raw DB imports in app code | All 4 apps clean — no raw DB imports | 1480ms |
...
| ✅ | Auth middleware: All apps have auth middleware | All 4 apps have auth middleware | 0ms |
...
| ✅ | Contract tests: ≥20 test files exist | 179 contract test files (require ≥20) | 4ms |
...
| ✅ | Studio maturity: Every app scores ≥ 7/10 on platform integration | All 17 apps score ≥ 7/10 on platform integration | 10ms |
| ✅ | Studio maturity: No AI marketing claims without ai-sdk wiring | All apps with AI claims have runtime ai-sdk wiring | 8ms |
| ✅ | Studio maturity: No in-memory Maps used as primary persistence | No in-memory Map stores used as primary persistence in app code | 2411ms |
