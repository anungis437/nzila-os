...
**Overall**: ✅ PASS
**Commit**: `93dce868`
**Timestamp**: 2026-04-17T18:50:58.848Z
**Duration**: 4722ms
**CI**: No
...
|--------|------|---------|----------|
| ✅ | Org boundary: No raw DB imports in app code | All 4 apps clean — no raw DB imports | 1823ms |
...
| ✅ | CI gates: Required security checks present in workflows | All 5 required CI checks present in workflows | 8ms |
...
| ✅ | Contract tests: ≥20 test files exist | 211 contract test files (require ≥20) | 6ms |
...
| ✅ | Studio maturity: Every app scores ≥ 7/10 on platform integration | All 17 apps score ≥ 7/10 on platform integration | 13ms |
| ✅ | Studio maturity: No AI marketing claims without ai-sdk wiring | All apps with AI claims have runtime ai-sdk wiring | 8ms |
| ✅ | Studio maturity: No in-memory Maps used as primary persistence | No in-memory Map stores used as primary persistence in app code | 2686ms |
