...
**Overall**: ✅ PASS
**Commit**: `de9d036ab`
**Timestamp**: 2026-05-11T04:51:45.081Z
**Duration**: 6454ms
**CI**: No
...
|--------|------|---------|----------|
| ✅ | Org boundary: No raw DB imports in app code | All 4 apps clean — no raw DB imports | 1790ms |
...
| ✅ | CI gates: No || true on security-gating commands | No \|\| true on security-gating commands in CI workflows | 11ms |
| ✅ | ESLint: All apps enforce boundary rules | All 4 apps enforce 3 boundary rules | 2ms |
| ✅ | Contract tests: ≥20 test files exist | 248 contract test files (require ≥20) | 6ms |
...
| ✅ | Studio maturity: Every app scores ≥ 7/10 on platform integration | All 26 apps score ≥ 7/10 on platform integration | 17ms |
| ✅ | Studio maturity: No AI marketing claims without ai-sdk wiring | All apps with AI claims have runtime ai-sdk wiring | 13ms |
| ✅ | Studio maturity: No in-memory Maps used as primary persistence | No in-memory Map stores used as primary persistence in app code | 4491ms |
