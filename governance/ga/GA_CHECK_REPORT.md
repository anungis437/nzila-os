...
**Overall**: ✅ PASS
**Commit**: `1e4b5e08`
**Timestamp**: 2026-04-30T12:53:53.238Z
**Duration**: 6511ms
**CI**: No
...
|--------|------|---------|----------|
| ✅ | Org boundary: No raw DB imports in app code | All 4 apps clean — no raw DB imports | 2938ms |
...
| ✅ | CI gates: No || true on security-gating commands | No \|\| true on security-gating commands in CI workflows | 8ms |
| ✅ | ESLint: All apps enforce boundary rules | All 4 apps enforce 3 boundary rules | 1ms |
| ✅ | Contract tests: ≥20 test files exist | 233 contract test files (require ≥20) | 4ms |
...
| ✅ | Studio maturity: Every app scores ≥ 7/10 on platform integration | All 24 apps score ≥ 7/10 on platform integration | 14ms |
| ✅ | Studio maturity: No AI marketing claims without ai-sdk wiring | All apps with AI claims have runtime ai-sdk wiring | 20ms |
| ✅ | Studio maturity: No in-memory Maps used as primary persistence | No in-memory Map stores used as primary persistence in app code | 3392ms |
