...
**Overall**: ✅ PASS
**Commit**: `b452107a`
**Timestamp**: 2026-04-25T16:44:39.978Z
**Duration**: 4956ms
**CI**: No
...
|--------|------|---------|----------|
| ✅ | Org boundary: No raw DB imports in app code | All 4 apps clean — no raw DB imports | 2077ms |
...
| ✅ | CI gates: Required security checks present in workflows | All 5 required CI checks present in workflows | 30ms |
...
| ✅ | Contract tests: ≥20 test files exist | 220 contract test files (require ≥20) | 3ms |
...
| ✅ | Studio maturity: Every app scores ≥ 7/10 on platform integration | All 19 apps score ≥ 7/10 on platform integration | 13ms |
| ✅ | Studio maturity: No AI marketing claims without ai-sdk wiring | All apps with AI claims have runtime ai-sdk wiring | 19ms |
| ✅ | Studio maturity: No in-memory Maps used as primary persistence | No in-memory Map stores used as primary persistence in app code | 2680ms |
