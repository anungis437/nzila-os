...
**Overall**: ✅ PASS
**Commit**: `2077023af`
**Timestamp**: 2026-05-07T22:03:20.770Z
**Duration**: 3417ms
**CI**: No
...
|--------|------|---------|----------|
| ✅ | Org boundary: No raw DB imports in app code | All 4 apps clean — no raw DB imports | 1625ms |
...
| ✅ | CI gates: Required security checks present in workflows | All 5 required CI checks present in workflows | 1ms |
...
| ✅ | ESLint: All apps enforce boundary rules | All 4 apps enforce 3 boundary rules | 0ms |
| ✅ | Contract tests: ≥20 test files exist | 234 contract test files (require ≥20) | 4ms |
...
| ✅ | Studio maturity: Every app scores ≥ 7/10 on platform integration | All 26 apps score ≥ 7/10 on platform integration | 11ms |
| ✅ | Studio maturity: No AI marketing claims without ai-sdk wiring | All apps with AI claims have runtime ai-sdk wiring | 8ms |
| ✅ | Studio maturity: No in-memory Maps used as primary persistence | No in-memory Map stores used as primary persistence in app code | 1679ms |
