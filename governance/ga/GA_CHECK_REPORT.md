...
**Overall**: ✅ PASS
**Commit**: `a8fe1b39`
**Timestamp**: 2026-04-22T04:25:31.200Z
**Duration**: 4353ms
**CI**: No
...
|--------|------|---------|----------|
| ✅ | Org boundary: No raw DB imports in app code | All 4 apps clean — no raw DB imports | 1980ms |
...
| ✅ | CI gates: No || true on security-gating commands | No \|\| true on security-gating commands in CI workflows | 5ms |
| ✅ | ESLint: All apps enforce boundary rules | All 4 apps enforce 3 boundary rules | 1ms |
| ✅ | Contract tests: ≥20 test files exist | 220 contract test files (require ≥20) | 8ms |
...
| ✅ | Studio maturity: Every app scores ≥ 7/10 on platform integration | All 19 apps score ≥ 7/10 on platform integration | 7ms |
| ✅ | Studio maturity: No AI marketing claims without ai-sdk wiring | All apps with AI claims have runtime ai-sdk wiring | 6ms |
| ✅ | Studio maturity: No in-memory Maps used as primary persistence | No in-memory Map stores used as primary persistence in app code | 2265ms |
