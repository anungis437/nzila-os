...
2. **Least Privilege** — Users only get the minimum access necessary
3. **Security by Design** — Built into our product and system architectures
4. **Encryption First** — All data encrypted in transit and at rest
5. **Auditability & Logging** — All key actions are tracked and reviewable
6. **Resilience & Recovery** — Redundancies and recovery paths are in place
