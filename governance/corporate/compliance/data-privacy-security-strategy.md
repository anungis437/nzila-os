...
2. **Storage** – Encrypted, access-controlled, audit-logged
3. **Usage** – Consent-bound, role-restricted, usage-minimized
4. **Retention** – Business-justified durations, auto-purging rules
5. **Disposal** – Secure deletion protocols and certificate generation
