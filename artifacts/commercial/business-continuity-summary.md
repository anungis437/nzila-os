...
> Live RTO measurement is scheduled for 2026-Q2. We will not claim
...
|-------|------|------|--------|
| Evidence audit (infrastructure + procedure) | 2026-04-24 | Dry-run | Infrastructure confirmed; runbooks live |
| Live staging restore (measured RTO) | 2026-Q2 | Full restore | Scheduled |
