...
> Auto-generated on 2026-04-14 by `tooling/repo-inventory`. Do not edit manually.
...
| Packages | 166 |
| GitHub Workflows | 35 |
| Contract Test Files | 193 |
| TS/JS Test Files | 1129 |
...
| agrimo | Next.js + Django | 3010 | ✅ | ✅ | ✅ | ✅ | 100 | Agricultural field operations — harvest tracking, production management, logisti |
| cfo | Next.js | 3008 | ✅ | ✅ | ✅ | ✅ | 234 | CFO finance dashboard — ledger management, tax tools, AI advisory, document inte |
| console | Next.js | 3001 | ✅ | ✅ | ✅ | ✅ | 206 | Internal operations console — platform governance, compliance, analytics, integr |
| control-plane | Next.js | 3010 | ✅ | ✅ | ✅ | ✅ | 173 | Platform control plane — multi-tenant governance, workflow orchestration, anomal |
...
| nacp-exams | Next.js | 3005 | ✅ | ✅ | ✅ | ✅ | 61 | National Anti-Corruption Programme examination and assessment platform. |
| orchestrator-api | Fastify | — | ✅ | ✅ | ❌ | ❌ | 21 | Fastify-based API server for workflow orchestration, job dispatch, and platform  |
| partners | Next.js | 3002 | ✅ | ✅ | ✅ | ✅ | 100 | Partner portal for managing deals, commissions, certifications, and go-to-market |
| platform-admin | Next.js | 3005 | ✅ | ✅ | ✅ | ✅ | 26 | Internal admin console for managing platform intelligence services — events, kno |
| trade | Next.js | 3009 | ✅ | ✅ | ✅ | ✅ | 51 | Cross-border trade management — deals, listings, shipments, and commission track |
| union-eyes | Next.js + Django | 3003 | ✅ | ✅ | ✅ | ✅ | 3032 | Full-stack union case management platform — grievance lifecycle, collective barg |
| web | Next.js | 3000 | ✅ | ✅ | ❌ | ✅ | 60 | Public marketing site for the Nzila platform — landing pages, resource library,  |
| zonga | Next.js + Django | 3011 | ✅ | ✅ | ✅ | ✅ | 401 | Africa-first music distribution, streaming, and royalty management platform. |
